...
static unsigned int sqlctx = 3449867;
...
{12,4138,1,0,0,
5,0,0,1,80,0,5,49,0,0,2,2,0,1,0,1,97,0,0,1,3,0,0,
};
...

{
   ...
   sqlstm.stmt = "update CO_MOROSOS  set COD_PTOGEST=:b0,FEC_PTOGEST=SYSDATE\
 where COD_CLIENTE=:b1";
   ...
   sqlstm.sqhstv[0] = (unsigned char  *)szhCTAFN;
