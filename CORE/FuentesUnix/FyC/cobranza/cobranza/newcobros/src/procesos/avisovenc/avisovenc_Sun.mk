...
LIB_DINA=-lAsigCobExt -lAsigCobJud -lAsigDicom -lAsigEJecCobCen -lAsigEJecCobSuc -lAsigEjecPerfil \
		 -lBaja -lBloquea -lcamnum -lCartaCob -lCtaFinal -lDesAsigCobExt -lDesAsigDicom -lDesBloquea \
		 -lDesEnrutamiento -lEnrutamiento -lMensAviso -lMensCorta -lMensFact -lNewMensCorta -lOutBound \
		 -lPreBaja -lRepBi -lRepone -lRevBaja -lSuspBeep -lSuspeTot -lSuspeUni
