...
OBJETOS_EXT=$(GE_LIB_PATH)/genco.o $(GE_LIB_PATH)/geora.o $(GE_LIB_PATH)/rutinasgen.o $(GE_LIB_PATH)/GenFA.o $(GE_LIB_PATH)/errores.o $(GE_LIB_PATH)/ORAcarga.o $(GE_LIB_PATH)/trazafact.o $(GE_LIB_PATH)/FaORA.o
