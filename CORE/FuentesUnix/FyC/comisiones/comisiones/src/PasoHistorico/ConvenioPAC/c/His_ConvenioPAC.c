...
{
    23,
    "./pc/His_ConvenioPAC.pc"
};


static unsigned int sqlctx = 442530307;
...
{12,4128,2,27,0,
5,0,0,1,349,0,3,50,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,2,50,0,2,101,0,0,1,1,0,1,0,1,97,0,0,
43,0,0,3,48,0,1,226,0,0,0,0,0,1,0,
58,0,0,4,0,0,30,285,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.stmt = "insert into CM_CONVENIOS_TH (NUM_GENERAL,COD_TIPCOMIS,COD_CO\
MISIONISTA,COD_CLIENTE,COD_PERIODO,ID_PERIODO,FEC_CONVENIO,COD_TIPORED,COD_TIP\
VENDEDOR,COD_VENDEDOR)select NUM_GENERAL ,COD_TIPCOMIS ,COD_COMISIONISTA ,COD_\
CLIENTE ,COD_PERIODO ,ID_PERIODO ,FEC_CONVENIO ,COD_TIPORED ,COD_TIPVENDEDOR ,\
COD_VENDEDOR  from CM_CONVENIOS_TO where ID_PERIODO=:b0";
