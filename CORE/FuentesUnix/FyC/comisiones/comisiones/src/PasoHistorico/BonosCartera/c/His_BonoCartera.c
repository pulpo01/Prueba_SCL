...
{
    23,
    "./pc/His_BonoCartera.pc"
};


static unsigned int sqlctx = 442511971;
...
{12,4128,2,27,0,
5,0,0,1,552,0,3,50,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,2,51,0,2,116,0,0,1,1,0,1,0,1,97,0,0,
43,0,0,3,48,0,1,244,0,0,0,0,0,1,0,
58,0,0,4,0,0,30,303,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.stmt = "insert into CM_BONOSCARTERA_TH (NUM_GENERAL,COD_TIPCOMIS,COD\
_COMISIONISTA,COD_AGENCIA,COD_CLIENTE,NUM_ABONADO,COD_PLANTARIF,IND_ORDENTOTAL\
,IMP_TRAFICO,IMP_CARGOBASICO,COD_CICLFACT,COD_PERIODO,ID_PERIODO,COD_TIPORED,C\
OD_TIPVENDEDOR,COD_PLANCOMIS,COD_CONCEPTO)(select NUM_GENERAL ,COD_TIPCOMIS ,C\
OD_COMISIONISTA ,COD_AGENCIA ,COD_CLIENTE ,NUM_ABONADO ,COD_PLANTARIF ,IND_ORD\
ENTOTAL ,IMP_TRAFICO ,IMP_CARGOBASICO ,COD_CICLFACT ,COD_PERIODO ,ID_PERIODO ,\
COD_TIPORED ,COD_TIPVENDEDOR ,COD_PLANCOMIS ,COD_CONCEPTO  from CMT_BONOSCARTE\
RA where ID_PERIODO=:b0)";
