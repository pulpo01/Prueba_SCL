...
static unsigned int sqlctx = 55329091;
...
{12,4128,2,27,0,
5,0,0,1,297,0,3,51,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,2,318,0,3,89,0,0,1,1,0,1,0,1,97,0,0,
43,0,0,3,491,0,3,129,0,0,1,1,0,1,0,1,97,0,0,
62,0,0,4,50,0,2,193,0,0,1,1,0,1,0,1,97,0,0,
81,0,0,5,49,0,2,209,0,0,1,1,0,1,0,1,97,0,0,
100,0,0,6,52,0,2,225,0,0,1,1,0,1,0,1,97,0,0,
119,0,0,7,48,0,1,353,0,0,0,0,0,1,0,
134,0,0,8,0,0,30,417,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.stmt = "insert into CM_VALORIZADOS_TH (NUM_GENERAL,COD_UNIVERSO,COD_\
CONCEPTO,COD_TIPCOMIS,COD_COMISIONISTA,COD_PERIODO,ID_PERIODO,IMP_CONCEPTO)(se\
lect NUM_GENERAL ,COD_UNIVERSO ,COD_CONCEPTO ,COD_TIPCOMIS ,COD_COMISIONISTA ,\
COD_PERIODO ,ID_PERIODO ,IMP_CONCEPTO  from CMT_VALORIZADOS where ID_PERIODO=:\
b0)";
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into CM_ACUMULADOS_TH (COD_CONCEPTO,COD_PERIODO,ID_PE\
RIODO,COD_TIPCOMIS,COD_COMISIONISTA,NUM_LOGRO,IMP_CONCEPTO,NUM_REGISTROS,COD_T\
IPORED)(select COD_CONCEPTO ,COD_PERIODO ,ID_PERIODO ,COD_TIPCOMIS ,COD_COMISI\
ONISTA ,NUM_LOGRO ,IMP_CONCEPTO ,NUM_REGISTROS ,COD_TIPORED  from CMT_ACUMULAD\
OS where ID_PERIODO=:b0)";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into CM_LIQUIDACION_TH (COD_COMISIONISTA,COD_TIPCOMIS\
,COD_PERIODO,ACUM_COMISION,ACUM_PENALIZACION,ACUM_ANTICIPO,ACUM_AJUSTES,ACUM_N\
ETO,ACUM_IMPUESTO,TOT_PAGAR,COD_TIPORED,ID_PERIODO,IND_APLIC_SUBORDINADA,IND_C\
UMPLIMIENTO)(select COD_COMISIONISTA ,COD_TIPCOMIS ,COD_PERIODO ,ACUM_COMISION\
 ,ACUM_PENALIZACION ,ACUM_ANTICIPO ,ACUM_AJUSTES ,ACUM_NETO ,ACUM_IMPUESTO ,TO\
T_PAGAR ,COD_TIPORED ,ID_PERIODO ,IND_APLIC_SUBORDINADA ,IND_CUMPLIMIENTO  fro\
m CM_LIQUIDACION_TO where ID_PERIODO=:b0)";
 sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from CMT_ACUMULADOS  where ID_PERIODO=:b0";
    sqlstm.iters = (unsigned int  )1;
