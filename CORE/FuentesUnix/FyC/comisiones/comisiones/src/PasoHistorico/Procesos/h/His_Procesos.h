...
#define GLOSA_PROG     "PASO HISTORICO TABLAS DE PROCESOS"
#define PROG_VERSION   "CUZCO 4.0"
#define LAST_REVIEW    "30-SEP-2003 (mwn70192)."
#define LOGNAME        "His_Procesos"
...
{
        long    lSegProceso     ;
        long    lRegInsertosValoriza;
        long    lRegInsertosAcumula;
        long    lRegInsertosLiquida;
}rg_estadistica;
