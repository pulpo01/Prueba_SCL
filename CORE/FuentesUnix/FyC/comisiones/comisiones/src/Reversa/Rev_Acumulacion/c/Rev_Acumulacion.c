...
{
    23,
    "./pc/Rev_Acumulacion.pc"
};


static unsigned int sqlctx = 443622747;
...
{12,4128,2,27,0,
5,0,0,1,49,0,2,44,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,2,51,0,2,57,0,0,1,1,0,1,0,1,3,0,0,
43,0,0,3,53,0,2,69,0,0,1,1,0,1,0,1,3,0,0,
62,0,0,4,59,0,1,180,0,0,0,0,0,1,0,
77,0,0,5,0,0,30,247,0,0,0,0,0,1,0,
};
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "delete  from CMT_FONDOS_COAP  where COD_PERIODO=:b0";
        sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "delete  from CMT_CONSUMOS_COAP  where COD_PERIODO=:b0";
        sqlstm.iters = (unsigned int  )1;
