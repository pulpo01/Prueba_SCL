# Shell para ejecutar procesos sms_pac.
# Mayo del 2009
# H.Q.R.   
...
echo '\n'
echo '  *****  ENVIO DE SMS POR PAGOS AUTOMATICOS DE CUENTAS  *****\n ' 
...
echo '  EJECUTANDO PROCESO [ sms_pac ] \n ' 
${EXE}/sms_pac -u / -l $nivel -c $cod_banco  
RET=$?
echo '  Resultado sms_pac: '$RET'\n'
