package com.tmmas.scl.operations.smo.fulfillment.scaa.issserord.srvser.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.smo.fulfillment.scaa.issserord.srvser.properties.service");
		}
		return instance;
	}
