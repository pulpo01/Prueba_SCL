...
<body  class="body" onload="seteaRetorno()">
...
<input type=hidden name="flag" value="<% if (session.getAttribute("flagVendedor") == null) out.println("NO"); else out.println(session.getAttribute("flagVendedor"));%>">
<table width="100%">
...
<table width="100%">
 <tr>
	<!-- Operadora -->
    <td class="barraarriba">Usuario: <c:out value="${clienteOS.usuario}"/>  &nbsp;Operadora: Movistar Colombia
  </td>
 </tr>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="30%">
    	...
    	&nbsp;&nbsp;
    	<html:radio property="ind_interno" value="1"  /> Directo
		&nbsp;&nbsp;
