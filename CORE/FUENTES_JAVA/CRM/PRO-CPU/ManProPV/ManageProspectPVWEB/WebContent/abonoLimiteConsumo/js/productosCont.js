...
function gestionProductoCont(checkeo,idproducto,isPaquete,idProdContratado,esAutoAfin, combo)
{	
	var ProductoKey='';
	combo.disabled = true;
...
function syncSelectContratado(Select, theValue)
{
	laFila = 0;
	elFin = Select.length;
	for(i = 0; i < elFin; i++)
...
function gestionProducto(textbox,checkeo,idproducto,isPaquete,codProducto,esAutoAfin, esHijo, combo)
{	
	var ProductoKey;
	var valorActual;
	var textboxmax;
