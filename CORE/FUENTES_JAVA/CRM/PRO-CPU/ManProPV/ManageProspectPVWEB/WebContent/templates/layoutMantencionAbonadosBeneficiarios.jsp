...
<script type='text/javascript' src='/ManageProspectPVWEB/dwr/interface/JOrdServAboBenef.js'></script>
...
function enviarFormulario()
{
	try
	{
		...
		if(numLista < 1)
		{
			//alert("No ha ingresado abonados, la orden de servicio no puede continuar.")
	   		return;
		}
