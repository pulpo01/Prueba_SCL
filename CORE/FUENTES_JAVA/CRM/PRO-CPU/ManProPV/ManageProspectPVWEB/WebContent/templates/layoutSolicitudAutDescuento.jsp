...
{
    var numAut =  document.getElementById("numAutorizacion").value ;
    if (accion=="ConsultarEstado" && (numAut==null || numAut=="") ){
    	alert("Debe Solicitar Numero de Autorizacion");
    }else{
...
function inicio()
{
	...
	if (numAutorizacion == " " || numAutorizacion == null){
