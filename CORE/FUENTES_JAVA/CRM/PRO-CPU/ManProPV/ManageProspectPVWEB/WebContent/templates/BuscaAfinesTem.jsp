...
function validaInpuText()
  {
   ...
   var traenumeros = trim(document.getElementById("numeroCelular").value);
   document.getElementById("numeroCelular").value = traenumeros;
...
<body  onload="habilitaCombo(this);f_inicio();">
