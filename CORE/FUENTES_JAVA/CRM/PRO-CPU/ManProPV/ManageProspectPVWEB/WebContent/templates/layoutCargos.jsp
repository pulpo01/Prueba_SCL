...
<c:set var="mensajeError" value="${sessionScope.mensajeError}"></c:set>
...
function inicio(){
  ...
  <c:if test="${not empty mensajeError}">
 	document.getElementById("mensajes").innerHTML = "<c:out value="${mensajeError}"/>";
	desactivarTodosControles(true);

	document.getElementById("Siguiente").disabled=true;
    document.getElementById("Siguiente2").disabled=true;
    document.getElementById("rbCiclo").disabled=true;
    document.getElementById("cbModPago").disabled=true;
    document.getElementById("cbTipoDocumento").disabled=true;
...
function limpiaFormateo( textoCelda )	{
	...
	var vacio = "" ;
	var textoFinal = new String(vacio);
