    ...
    <td colspan="3">
     ...
     <tr>
       ...
       <td width="50%" align="right">
		  ...
		  onmouseover="sobreElBoton('Siguiente2','botones/btn_siguiente_roll.gif')" onMouseOut="sobreElBoton('Siguiente2','botones/btn_siguiente.gif')" onclick="enviarFormularioLC();setValorSeleccionados();" />
