    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="162" class="valorCampoSeleccionable">
          <div style="visibility: <% if (request.getAttribute("Vis_CargosCicloRB").equals("SI")) out.write("visible"); else  out.write("hidden"); %>">
        	Si <html:radio  tabindex="1" property="rbCiclo" value="NO" name="CargosForm" disabled="${Hab_CargosCicloRB}" />
        	No <html:radio  tabindex="2" property="rbCiclo" value="SI" name="CargosForm" disabled="${Hab_CargosCicloRBNO}" />
          </div>        	
        </td>
        <td width="32">&nbsp;</td>
