...
function enviarFormulario2()
  {
      document.forms[0].action="/ClienElimAfinesAction.do";
...
<html:hidden property="guardarCancelar"/>
  <tr>
      <td colspan="6"><table width="100%" border="0">
        <tr>
          <td width="6%">&nbsp;</td>
          <td width="13%"><strong><img src="img/botones/btn_eliminar.gif" name="eliminar" id="eliminar" onclick="eliminarRegistro();" width="85" height="19" id="eliminar" 	onmouseover="sobreElBoton('eliminar','img/botones/btn_eliminar_roll.gif')" onmouseout="sobreElBoton('eliminar','img/botones/btn_eliminar.gif')" /></strong></td>
