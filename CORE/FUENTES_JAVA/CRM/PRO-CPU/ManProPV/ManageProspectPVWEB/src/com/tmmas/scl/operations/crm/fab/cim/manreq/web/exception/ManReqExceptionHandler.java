 ...
 */
package com.tmmas.scl.operations.crm.fab.cim.manreq.web.exception;
...
public class ManReqExceptionHandler extends ExceptionHandler {
	private final Logger logger = Logger.getLogger(ManReqExceptionHandler.class);
