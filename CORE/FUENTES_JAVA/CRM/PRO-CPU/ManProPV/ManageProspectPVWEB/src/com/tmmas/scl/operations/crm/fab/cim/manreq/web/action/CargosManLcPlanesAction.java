...
public class CargosManLcPlanesAction extends BaseAction {
	
	

	private final Logger logger = Logger.getLogger(CargosManLcPlanesAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		logger.debug("No se cobran cargos de negocio mantención de limites de consumo");
