...
public class ProductoForm  extends ActionForm{
	...
	private String bitacoradindexcant;
	private String listaProductosContrados;
	...
	public String getListaProductosContrados() {
		return listaProductosContrados;
	}

	public void setListaProductosContrados(String listaProductosContrados) {
		this.listaProductosContrados = listaProductosContrados;
	}

	public String getBitacoradindexcant() {
		return bitacoradindexcant;
	}

	public void setBitacoradindexcant(String bitacoradindexcant) {
		this.bitacoradindexcant = bitacoradindexcant;
	}
