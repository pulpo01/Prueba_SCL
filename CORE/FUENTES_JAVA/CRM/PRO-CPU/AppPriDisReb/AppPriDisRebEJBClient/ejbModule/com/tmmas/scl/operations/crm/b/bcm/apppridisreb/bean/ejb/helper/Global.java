package com.tmmas.scl.operations.crm.b.bcm.apppridisreb.bean.ejb.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.b.bcm.apppridisreb.bean.ejb.properties.negocio");
		}
		return instance;
	}
