...
public class DescontratarOfertaComercialVenAsinSRVORC extends VentaAsincronaCmdORC
{
	...
	public DescontratarOfertaComercialVenAsinSRVORC() {
		// TODO Auto-generated constructor stub
	}

	public DescontratarOfertaComercialVenAsinSRVORC(AsyncProcessParameterObject value) {
		super(value);		
	}

	
	public void ejecutarDescontratar(ProductoContratadoListDTO productoContratadoList)	throws NegSalException 
	{
...
//	----------------------------------------------------------------------------------------------
	...
	public void onInit() throws GeneralException {
		...
		ProductoContratadoListDTO productoContratadoList;
		...
		productoContratadoList = (ProductoContratadoListDTO)parametros.getArgumentsData();
	...
	public AsyncProcessResponseObject start() throws GeneralException {
		...
		try {
			...
			this.ejecutarDescontratar(productoContratadoList);
