...
public class AnulacionContratacionVenAsinSRVORC extends VentaAsincronaCmdORC
{
	...
	public AnulacionContratacionVenAsinSRVORC() {
		// TODO Auto-generated constructor stub
	}

	public AnulacionContratacionVenAsinSRVORC(AsyncProcessParameterObject value) {
		super(value);		
	}

	
	public void ejecutarAnulacionVenta(VentaDTO venta)
		throws NegSalException {
		cat.debug("ejecutarAnulacionVenta():start");		
		RetornoDTO retorno= null;		
		
		try
		{		
			cat.debug("AQUI DEBE EJECUTAR PROCESO");
			retorno = this.getIssCusOrdORC().anulacionVenta(venta);
		}
		catch(Exception e)
		{
		...
		cat.debug("ejecutarAnulacionVenta():end");	
...
//	----------------------------------------------------------------------------------------------
	...
	public void onInit() throws GeneralException {
		...
		ventaDTO = (VentaDTO)parametros.getArgumentsData();
		
		cat.debug("ventaDTO.getIdVenta():   "+ventaDTO.getIdVenta());
	...
	public AsyncProcessResponseObject start() throws GeneralException {
		...
		try {
			...
			this.ejecutarAnulacionVenta(ventaDTO);
			cat.debug("Proceso terminó satisfactoriamente");
		} catch (Exception e) {
			cat.debug("Error, se procede a ejecutar rollback");
			throw new GeneralException("A ocurrido un error al ejecutar la anulacion de venta", e); 
		}
