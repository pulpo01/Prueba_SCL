...
/**
 * Utility class for VentaMDB.
 * @generated 
 * @wtp generated
 */
public class VentaMDBUtil
{
  ...
  private static final java.lang.String DESTINATION_JNDI_NAME="VentaMDB";
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";

   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Queue for VentaMDB. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for VentaMDB. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("VentaMDBUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
