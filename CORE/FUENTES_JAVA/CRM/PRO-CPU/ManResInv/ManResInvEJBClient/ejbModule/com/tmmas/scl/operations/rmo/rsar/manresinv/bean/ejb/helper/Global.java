package com.tmmas.scl.operations.rmo.rsar.manresinv.bean.ejb.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.rmo.rsar.manresinv.bean.ejb.properties.negocio");
		}
		return instance;
	}	
}
