package com.tmmas.scl.operations.rmo.rsar.manresinv.srvglp.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.rmo.rsar.manresinv.srvglp.properties.service");
		}
		return instance;
	}	
}
