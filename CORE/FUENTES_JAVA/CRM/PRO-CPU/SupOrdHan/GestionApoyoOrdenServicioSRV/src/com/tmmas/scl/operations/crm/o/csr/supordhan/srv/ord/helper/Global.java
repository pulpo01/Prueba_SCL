package com.tmmas.scl.operations.crm.o.csr.supordhan.srv.ord.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.o.csr.supordhan.srv.ord.properties.service");
		}
		return instance;
	}	
}
