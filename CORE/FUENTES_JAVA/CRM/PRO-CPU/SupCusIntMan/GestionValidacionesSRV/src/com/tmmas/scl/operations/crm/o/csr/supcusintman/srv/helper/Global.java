package com.tmmas.scl.operations.crm.o.csr.supcusintman.srv.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.o.csr.supcusintman.srv.properties.service");
		}
		return instance;
	}	
}