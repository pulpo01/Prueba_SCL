      ...
      <td colspan="6"><table width="100%" border="0">
        <tr>
          ...
          <td width="8%" valign="bottom"><strong>
            ...
            <input name="codigoCliente" type="text"  id="codigoCliente" value="" width="50" maxlength="10" onkeypress="limpiaText();" onfocus="limpiaText();"/>
      ...
      <td colspan="5"><table width="100%" border="0">
          ...
          <logic:present name="listaClientes" scope="session"> 
             <logic:iterate id="cliente" name="listaClientes"  type="com.tmmas.scl.framework.customerDomain.customerABE.dataTransferObject.ClienteDTO" scope="session">
		          <tr>
			        <td class="textoFilasTabla"> <input type="checkbox" name="itemChequeados" id="itemChequeados"  value='<bean:write name="cliente" property="codCliente"/>' /></td>
