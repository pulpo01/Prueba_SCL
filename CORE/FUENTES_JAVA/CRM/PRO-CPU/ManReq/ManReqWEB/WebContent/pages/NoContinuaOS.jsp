...
<c:set var="mensajeError" value="${sessionScope.error}"></c:set> 
...
<table width="100%" border="0">
  ...
  <tr>
     <td colspan="5" align="center" class="textoSubTitulo">Error</td>
  </tr>
  <tr>
    <td width="18%">&nbsp;</td>
    <td width="12%">&nbsp;</td>
  ...
  <tr>
    <td class="mensajeError" width="100%" align="center"><c:out value="${mensajeError}"/></td>
  </tr>
