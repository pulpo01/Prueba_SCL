...
<table border="0" width="100%">
      ...
      <td width="97%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <td width="287" class="textoColumnaTabla">
    <!-- INC-72028; AVC; 24-10-2008  Se ocultan campos con el tag DIV -->
	            <div id="capaActivarPlanORango" style="position:absolute;width:100;height:100;top:123;left:208;visibility:hidden">
							  <label><html:radio onclick="activarPlanORango(this)" name="CambiarPlanForm" property="radioPlanORango" value="radioRango" />Rango</label>
							</div>  	
						</td> 
			  </tr>
			  ...
			  <tr>
			   ...
			   <html:select onchange="validaComboPlanTarif(this)" size="3" property="combopos" >
				      ...
				      <td class="campoSeleccionable">
				       <!-- INC-72028; AVC; 24-10-2008  Se ocultan campos con el tag DIV -->
				      	<div id="capaMontoCargoBasico" style="position:absolute;width:100;height:100;top:123;left:208;visibility:hidden"> 
				      	   Monto Cargo B&aacute;sico				  
			  ...
			  <tr>
				<td>&nbsp;</td>
				   ...
				   <td class="campoSeleccionable">
				   	 <!-- INC-72028; AVC; 24-10-2008  Se ocultan campos con el tag DIV -->
				     <div id="capaRangos" style="position:absolute;width:100;height:100;top:123;left:208;visibility:hidden"> 
				   	    Rangos					
