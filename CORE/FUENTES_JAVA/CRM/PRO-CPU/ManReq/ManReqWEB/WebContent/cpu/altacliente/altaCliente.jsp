...
/********************************************************************************************/	   
	   function validarDatosObligatoriosCliente() {
	      ...
	      { 
			...
			/*if (checkSelect($("tipoIdentificacionCliente") )  ) {
				fncValidaTipoIdentificacion(  document.getElementById("tipoIdentificacionCliente").value,document.getElementById("numeroIdentificacionCliente"));
			}
			if (checkSelect($("tipoIdentificacionApoderado") ))	{
				fncValidaTipoIdentificacion(document.getElementById("tipoIdentificacionApoderado").value,document.getElementById("numeroIdentificacionApoderado"));
			}*/
...
/********************************************************************************************/	      
	   // INICIO RRG   
	   function fncCarga() {
			//alert("fncCarga"+ document.getElementById("tipoComboPlanCpu").value);
			fncCargaTipoPlan();
			fncCargaCicloDefault();

	   }   
       function fncCargaTipoPlan() {
			var strUsoPlanDestino = document.getElementById("tipoComboPlanCpu").value;
			if (strUsoPlanDestino=="combopre") document.getElementById("tipoComboPlanCpu").value = "1";
			if (strUsoPlanDestino=="combopos") document.getElementById("tipoComboPlanCpu").value = "2";
			if (strUsoPlanDestino=="combohib") document.getElementById("tipoComboPlanCpu").value = "3";
			document.getElementById("tipoComboPlanCpu").style.visibility = "hidden";	
			document.getElementById("tipoPlanDestino").style.visibility = "hidden";	
			document.getElementById("tipoPlanDestino").value = document.getElementById("tipoComboPlanCpu").value
	   }
	   // FIN RRG
/********************************************************************************************/	      
	// INICIO RRG  71895
	function fncValidaTipoIdentificacion(valorSel,objText) {
		LastObj = objText;
		if (objText.value != "") {
			blResultado = AltaClienteAJAX.validarNumeroIdentificacion(valorSel,objText.value,fncResultadoValidacion);
		}
		//alert(blResultado)
	}
	function fncResultadoValidacion(prmResultado) {
		if (!prmResultado) {
			alert("Valor de Identificacion no Valido");
			LastObj.focus();
			bIdentificacion = false;
			return false;
		}
		bIdentificacion = true;
		return true;
	}
	// fin RRG  71895
	// inicio 72637 RRG
	function fncCargaCicloDefault() {
			//alert("strUsoPlanDestino:" + document.getElementById("tipoComboPlanCpu").value);
			if (document.getElementById("tipoComboPlanCpu").value!=1) 
					blResultado = AltaClienteAJAX.obtenerCicloDefault(fncResultadoCicloDef); 
			else {
				try {	
					document.getElementById("cicloFact").listindex = 1;
				} catch (e) {
					return;
				}
			}
	}
	function fncResultadoCicloDef(prmResultado){
		try {
			document.getElementById("cicloFact").value = prmResultado;
		} catch (e) {
			return;
		}
...
<body onload='fncCarga()'>
	...
	<html:text name="AltaClienteActionForm" property="tipoComboPlanCpu" style="text-transform: uppercase;" size="5" maxlength="5" />	          
	<html:text name="AltaClienteActionForm" property="tipoPlanDestino" style="text-transform: uppercase;" size="5" maxlength="5" />	          
    ...
    <html:hidden property="numDiasSel"/>
     ...
     <TABLE align="center" width="90%">
        ...
        <tr>
          ...
          <td width="32%">
			  <html:select name="AltaClienteActionForm" property="tipoIdentificacionCliente" style="width:200px;"     onchange="fncValidaTipoIdentificacion(this.value,numeroIdentificacionCliente); ">
			  	<html:option value="">- Seleccione -</html:option>
          ...
          <td width="21%">
			  ...
			  <html:text name="AltaClienteActionForm" property="numeroIdentificacionCliente" size="37" maxlength="20" onkeyup="upperCase(this);"   
					onblur="fncValidaTipoIdentificacion(tipoIdentificacionCliente.value,this);"  
					onkeypress="if (window.event.keyCode == 13) fncValidaTipoIdentificacion(tipoIdentificacionCliente.value,this); "/>
          	  <script>
        ...
        <tr>
          ...
          <td width="32%">
			  <html:select name="AltaClienteActionForm" property="tipoIdentificacionApoderado" style="width:200px;" title="Tipo de Identificación del Apoderado" onchange="fncValidaTipoIdentificacion(this.value,numeroIdentificacionApoderado); ">
			  	<html:option value="">- Seleccione -</html:option>
			  	<logic:notEmpty name="AltaClienteActionForm" property="arrayIdentificadorCliente">
	              <html:optionsCollection property="arrayIdentificadorCliente" value="codigoTipIdentif" label="descripcionTipIdentif"/>
	          	</logic:notEmpty>
          ...
          <td width="21%">
			...
			<html:text name="AltaClienteActionForm" property="numeroIdentificacionApoderado" style="text-transform: uppercase;"  onkeyup="upperCase(this);" size="37" maxlength="20" title="Numero de Identificacion del Apoderado"  
			onblur="fncValidaTipoIdentificacion(tipoIdentificacionApoderado.value,this);"  
			onkeypress="if (window.event.keyCode == 13) fncValidaTipoIdentificacion(tipoIdentificacionApoderado.value,this);" />
		  </td>
        </tr>
        <tr>
          <td width="26%">
   ...
   <input type="hidden" name="tipoCliente" value="<bean:write name="AltaClienteActionForm" property="tipoCliente"/>"/>	
	...
	<TABLE align="center" width="90%" border="0" >
	     ...
	     <tr>
	          ...
	          <td>
				<html:text name="AltaClienteActionForm" property="numeroIdentificacionTrib" style="text-transform: uppercase;"  
				onkeyup="upperCase(this);" size="40" maxlength="40" title="Número de Identificación Tributaria"
				onblur="fncValidaTipoIdentificacion(tipoIdentificacionTrib.value,this);"  
				onkeypress="if (window.event.keyCode == 13) fncValidaTipoIdentificacion(tipoIdentificacionTrib.value,this); "
				/>	      	
				<script>
          ...
          <td colspan="4">
	        ...
	        <tr>
	          ...
	          <td width="32%">
				  ...
				  onchange="fncValidaTipoIdentificacion(tipoIdentificacionResponsable1.value,numeroIdentificacionResponsable1);"> 
			  		<html:option value="">- Seleccione -</html:option>
				  	<logic:notEmpty name="AltaClienteActionForm" property="arrayIdentificadorCliente">
		              <html:optionsCollection property="arrayIdentificadorCliente" value="codigoTipIdentif" label="descripcionTipIdentif"/>
		          	</logic:notEmpty>
	          ...
	          <td width="21%">
	          <html:text name="AltaClienteActionForm" property="numeroIdentificacionResponsable1" size="37" 
			  maxlength="15" style="text-transform: uppercase;"  onkeyup="upperCase(this);" 
			  onkeypress="if (window.event.keyCode == 13) fncValidaTipoIdentificacion(tipoIdentificacionResponsable1.value,this); "
			  onblur="fncValidaTipoIdentificacion(tipoIdentificacionResponsable1.value,this); "
			  />
			  </td>
	        </tr>
        <tr>
     ...
     <logic:equal name="AltaClienteActionForm" property="pagina" value="pagina4">
      <TABLE align="center" width="90%" border="0">
        ...
        <tr>
          ...
          <td width="30%">
            <html:text name="AltaClienteActionForm" property="numeroIdentificacionResponsable2" style="text-transform: uppercase;" 
				onblur="fncValidaTipoIdentificacion(tipoIdentificacionResponsable2.value,this);"  
				onkeypress="if (window.event.keyCode == 13) fncValidaTipoIdentificacion(tipoIdentificacionResponsable2.value,this) ;"
				onkeyup="upperCase(this);" size="20" maxlength="20" title="Numero de Identificacion del Segundo Responsable" />
		  </td>
        </tr>
        <tr>  
          <td width="20%">
