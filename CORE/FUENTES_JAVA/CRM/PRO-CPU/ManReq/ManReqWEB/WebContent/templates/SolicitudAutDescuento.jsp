...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>
    	<html:text name="SolicitudAutDescuentoForm" property="numAutorizacion" readonly="true"/>
    </td>
    <td> 
	    <img src="botones/btn_solicitar.gif"  border="0" id="solicitar"  name="solicitar" alt="Solicitar Descuento"
		onmouseover="sobreElBoton('solicitar','botones/btn_solicitar_roll.gif')" onmouseout="sobreElBoton('solicitar','botones/btn_solicitar.gif')" onclick="enviar('Solicitar');"/>
	</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td>
       	<html:text name="SolicitudAutDescuentoForm" property="estadoSolicitudGlosa" readonly="true"/>
    </td>
    <td>
    	<img src="botones/btn_consultar.gif"  border="0" id="consultar"  name="consultar" alt="Consultar Estado de Solicitud"
		onmouseover="sobreElBoton('consultar','botones/btn_consultar_roll.gif')" onmouseout="sobreElBoton('consultar','botones/btn_consultar.gif')" onclick="enviar('ConsultarEstado');"/>
	</td>
  </tr>
  <tr>
	<td colspan="5">&nbsp;</td>
