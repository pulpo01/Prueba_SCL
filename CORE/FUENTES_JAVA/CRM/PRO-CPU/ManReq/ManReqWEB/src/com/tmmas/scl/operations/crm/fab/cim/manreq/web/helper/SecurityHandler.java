...
public class SecurityHandler {
	...
	public ClienteOSSesionDTO validarSeguridad(HttpServletRequest req,
		...
		// Verifica si el parametro codOrdenServicio , viene con la etiqueta RENOVA;
		...
		if ( iposparamrenova > -1 ){
			...
			paramrenova=StrUtl.isNullCero(req.getParameter("codOrdenServicio")).substring(iposparamrenova + 6,lenparamrenova);
		//	fin-Proyecto p-mix-09003 OCB;
		}	
		else{
			// Indica que solo viene   el codigo de OOSS cuando es invocado desde Eureka o Example
			// EJEMPLO: codOrdenServicio->"40008" ;
		...
		//	ini-Proyecto p-mix-09003 OCB; 
		if (iposparamrenova > -1) {
                // Guarda valor para validar en la componente de cargos si fue invocada por el componente de renovación
