...
public class NumerosFrecuentesAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		else
		{
			...
			log2("form.getClass()   :"+form.getClass());
			...
			catch(Exception e)
			{
				...
				log2("del request.getParameter idProductoContratado "+idProductoContratado);
				log2("----------------->"+e.getMessage());//e.printStackTrace();
			}
			...
			//codPadrePaq = (String)session.getAttribute("codPadrePaq");
			log2(CLASS_NAME+"desde lista de productos idProductoContratado "+idProductoContratado);
			//log2(CLASS_NAME+" en la session codPadrePaq "+codPadrePaq);
		...
		log2("arrTipos.size() "+arrTipos.size());
