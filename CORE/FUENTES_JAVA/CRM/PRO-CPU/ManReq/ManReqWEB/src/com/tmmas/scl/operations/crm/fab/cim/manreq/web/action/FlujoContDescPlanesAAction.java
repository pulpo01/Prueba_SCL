					...
					if(!listaCargosAMostrar.isEmpty())
					{
						...
						while(it.hasNext())
						{
							...
							if(cargoWeb.getCodConcepto().equals(arrayCargosFiltrados[i].getCodConcepto()))
							{
								...
								importe=importe+Integer.parseInt(arrayCargosFiltrados[i].getImporte());
								cantidad++;
...
//		CALCULO DE DESCUENTOS 
	...
	private VentaDTO obtieneVentaDto(ClienteOSSesionDTO sessionData) throws GeneralException 
	{
