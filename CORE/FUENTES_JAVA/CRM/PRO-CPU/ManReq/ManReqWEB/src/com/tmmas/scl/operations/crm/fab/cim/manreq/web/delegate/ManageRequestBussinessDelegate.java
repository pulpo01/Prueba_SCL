...
public class ManageRequestBussinessDelegate {
	...
	private ManProOffInvFacade getManProOffInvFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getManProOffInvFacade():start");
	...
	private ManConFacade getManConFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getManConFacade():start");
	...
	private DetCusOrdFeaFacade getDetCusOrdFeaFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getDetCusOrdFeaFacade():start");
	...
	private SupOrdHanFacade getSupOrdHanFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getSupOrdHanFacade():start");
...
//	IssueCustomerOrderFacade
	private IssCusOrdFacade getIssCusOrdFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getIssCusOrdFacade():start");
	...
	private ManColFacade getManColFacade() throws ManReqException {
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.getManColFacade():start");
	...
	private AppPriDisRebFacade getAppPriDisRebFacade() throws ManReqException {
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.getAppPriDisRebFacade():start");
...
//	SupCusIntManFacade
	private SupCusIntManFacade getSupCusIntManFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getSupCusIntManFacade():start");
...
//	CloCusOrdFacade
	private CloCusOrdFacade getCloCusOrdFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getCloCusOrdFacade():start");
...
//	ManCusBilFacade
	private ManCusBilFacade getManCusBilFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getManCusBilFacade():start");
...
//	NegSalFacade
	private NegSalFacade getNegSalFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getNegSalFacade():start");
	...
	private ManCusInvFacade getManCusInvFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getManCusInvFacade():start");
...
//	 ConsultaFacade	
	private ConsultaFacadeSTL getConsultaFacadeSTL() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getConsultaFacadeSTL():start");
	...
	private FrmkCargosFacade getFrmkCargosFacade() throws ManReqException {
		...
		logger.debug("ManageRequestBussinessDelegate.getFrmkCargosFacade():start");
	...
	private VentasFacadeSTL getVentasFacade() throws ManReqException {
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.getVentasFacade():start");
...

	{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ejecutarOrdenServicioJms():start");
		...
		try
		{
			...
			String loge = StackTraceUtl.getStackTrace(e);
			logger.debug("FrameworkException[" + loge + "]");
			ManReqException ex = new ManReqException();
			logger.debug("Se crea disparador para la excepcion ManReqException, mensaje [" + e.getMessage() + "]");
...

	{
		...
		String sNombreMethodo = new String("ManageRequestBussinessDelegate.ejecutarMantencionProductosOSJms:");
...

	{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ejecutarOrdenServicioAbonadoBeneficiarioJms():start");
...

	{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ejecutarOrdenServicioAbonadoVetadoJms():start");
		String sNombreMethodo = new String("ejecutarOrdenServicioAbonadoVetadoJms:");
	...
	public AbonadoVetadoListDTO obtieneAbonadosVetados(AbonadoDTO abonadoDTO) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtieneAbonadosVetados():start");
		try {
   ...
   // INICIO RRG 17-02-2009 COL 78551
	public int validaAbonadoBajaProgramada(long numAbonado) throws ManReqException{

		int retValue;
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaAbonadoBajaProgramada():start");
		try {
			retValue= getManConFacade().validaAbonadoBajaProgramada(numAbonado);
...

	{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ejecutarMantencionFrecuentesOSJms():start");
		
		String sNombreMethodo = new String("ejecutarMantencionFrecuentesOSJms:");
		...
		try
		{
			...
			System.out.println("ENVIANDO "+ paramOServicio.getNumeroListAdd().getNumerosDTO().length+" NUMEROS FRECUENTES  A ENCOLAR A AGREGAR");
			System.out.println("ENVIANDO "+ paramOServicio.getNumeroListDel().getNumerosDTO().length+" NUMEROS FRECUENTES  A ENCOLAR A ELIMINAR");
...

	{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ejecutarOrdenServicioAfinesOSJms():start");
		
		String sNombreMethodo = new String("ejecutarOrdenServicioAfinesOSJms:");
	...
	public void ejecutarRegistroOrden(ParamMantencionProductoDTO param) throws ManReqException{
		...
		logger.debug("ManageRequestBussinessDelegate.ejecutarRegistroOrden():start");
		try{
	...
	public ClienteDTO obtenerDatosCliente(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosCliente():start");
		try {
	...
	public ClienteDTO obtenerDatosCliente(
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosClienteCuenta():start");
	...
	public AbonadoDTO obtenerDatosAbonado(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosAbonado():start");
		try {
	...
	public AbonadoListDTO obtenerListaAbonados(ClienteDTO cliente) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerListaAbonados():start");
		try {
	...
	public PlanTarifarioListDTO obtenerPlanesTarifarios(
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPlanesTarifarios():start");
		try {
	...
	public PlanTarifarioDTO obtenerTipoCobroPlanTarifario(
			PlanTarifarioDTO plan) throws ManReqException{	

		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerTipoCobroPlanTarifario():start");
		try {
			plan = getManProOffInvFacade().obtenerTipoCobroPlanTarifario(plan);
		}catch(ManReqException e){
			String loge = StackTraceUtl.getStackTrace(e);
			logger.debug("ManReqException[" + loge + "]");
			throw e;
	...
	public SubCuentaListDTO obtenerSubCuentas(ClienteDTO cliente) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerSubCuentas():start");
		try {
	...
	public ConversionListDTO obtenerConversionOOSS(ConversionDTO param) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerConversionOOSS():start");
		try {
	...
	public SaldoDTO consultaSaldo(ConsultaSaldoDTO consultaSaldo) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultaSaldo():start");
		try {
	 ...
	 * Consulta bolsas
	 * 
	 * @param consultaBolsas
	 * @return SaldoDTO
	 * @throws ManReqException
	 */
	public SaldoDTO consultaBolsas(ConsultaBolsasDTO consultaBolsas) throws ManReqException{
		SaldoDTO retorno = null;
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultaBolsas():start");
		try {
			retorno = getConsultaFacadeSTL().consultaBolsas(consultaBolsas);
	...
	public RetornoDTO consultaPrepago(ConsultaPrepagosDTO consulta) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultaPrepago():start");
		try {
	...
	public ParametroDTO obtenerParametroGeneral(ParametroDTO param) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerParametroGeneral():start");
		try {
	...
	public ParametroDTO obtenerParametrosSimples(ParametroDTO param) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerParametrosSimples():start");
		try {
	...
	public RetornoDTO validaRestriccionComerOoss(RestriccionesDTO restricciones) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaRestriccionComerOoss():start");
		try {
	...
	public AbonadoDTO obtenerDatosCambPlanServ(AbonadoDTO abonado) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosCambPlanServ():start");
		try {
	...
	public FormaPagoListDTO obtenerFromasPago(BusquedaFormasPagoDTO formaPago) throws ManReqException{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerFromasPago():start");
			try {
	...
	public DocumentoListDTO obtenerTiposDocumento(BusquedaTiposDocumentoDTO tipoDocumento) throws ManReqException{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerTiposDocumento():start");
			try {
	...
	public RetornoDTO eliminarSolicitud(RegistroSolicitudDTO registro) throws ManReqException{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.eliminarSolicitud():start");
		try {
	...
	public RetornoDTO eliminarPresupuesto(RegistroFacturacionDTO registro) throws ManReqException{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.eliminarPresupuesto():start");
		try {
	...
	public CuotasProductoDTO[] obtenerCuotasProducto() throws ManReqException{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCuotasProducto():start");
			try {
	...
	*/
	...
	public ObtencionCargosDTO obtencionCargos(com.tmmas.scl.framework.customerDomain.customerBillABE.dataTransferObject.ParametrosObtencionCargosDTO parametrosCargos) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtencionCargos():start");
	...
	private String obtenerMensaje(FrmkCargosException e) {
		String msg = null;
		logger.debug("ManageRequestBussinessDelegate.obtenerMensaje(FrmkCargosException e)");
	...
	public ParametroListDTO obtenerParametrosGenerales() throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerParametrosGenerales():start");
		try {
	...
	public ValidaOOSSDTO validaOossPendPlan(ValidaOOSSDTO ordenServicio) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaOossPendPlan():start");
		try {
	...
	public IOOSSDTO anulaOossPendPlan(IOOSSDTO ordenServicio) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.anulaOossPendPlan():start");
		try {
	...
	public CambioPlanPendienteListDTO obtenerSolicPendPlan(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerSolicPendPlan():start");
		try {
	...
	public CicloDTO obtenerFechaCiclo(CicloDTO ciclo) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerFechaCiclo():start");
		try {
	...
	public RetornoDTO validaFreedom(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaFreedom():start");
		try {
	...
	public PlanCicloDTO obtenerCicloFreedom(PlanCicloDTO plan) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCicloFreedom():start");
		try {
	...
	public RetornoDTO validaCuentaPersonal(CuentaPersonalDTO cuenta) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaCuentaPersonal():start");
		try {
	...
	public PlanTarifarioDTO obtenerCategPlan(PlanTarifarioDTO plan) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCategPlan():start");
		try {
	...
	public RetornoDTO eliminarPromocion(EliminaPromocionDTO param) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.eliminarPromocion():start");
		try {
	...
	public RetornoDTO obtenerPlanAtlantida(AbonadoDTO abonado) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPlanAtlantida():start");
		try {
	...
	public ClienteDTO obtenerValorCalculado(ClienteDTO cliente) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerValorCalculado():start");
		try {
	...
	public NumeroDTO obtenerTipoNumero(NumeroDTO parametro) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerTipoNumero():start");
		try {
	...
	public UsuarioDTO obtenerVendedor(UsuarioDTO usuario) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerVendedor():start");
		try {
	...
	public RetornoDTO validaPermanencia(ValidaPermanenciaDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaPermanencia():start");
		try {
	...
	public GaAbocelDTO obtenerFecCumPlan(GaAbocelDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerFecCumPlan():start");
		try {
	...
	public CargoClienteDTO obtenerCargoBasicoActual(CargoClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCargoBasicoActual():start");
		try {
	...
	public RetornoDTO anularCargoBolsaDinamica(BolsaDinamicaDTO bolsa) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.anularCargoBolsaDinamica():start");
		try {
	...
	public RetornoDTO validarPortabilidad(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarPortabilidad():start");
		try {
	...
	public RetornoDTO validarPeriodoFact(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarPeriodoFact():start");
		try {
	...
	public RetornoDTO validarServiciosDuplicados(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarServiciosDuplicados():start");
		try {
	...
	public ConvertActAboDTO obtenerConverActAbo(ConvertActAboDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerConverActAbo():start");
		try {
	...
	public CausaBajaListDTO obtenerCausaBaja() throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCausaBaja():start");
		try {
	...
	public ArchivoFacturaDTO obtenerRutaFactura(ArchivoFacturaDTO factura) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerRutaFactura():start");
		try {			
	...
	public CartaGeneralDTO obtenerTextoCarta(CartaGeneralDTO cartaGeneral) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerTextoCarta():start");
		try {			
	...
	public DescuentoVendedorDTO obtenerDescuentoVendedor(DescuentoVendedorDTO vendedor)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDescuentoVendedor():start");
		try {
	...
	public RespuestaSolicitudDTO solicitarAprobacionDescuento(RegistroSolicitudListDTO registro) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.solicitarAprobacionDescuento():start");
		try {
	...
	public RegistroSolicitudDTO consultarEstadoSolicitud(RegistroSolicitudDTO registro)	 throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultarEstadoSolicitud():start");
		try {
	...
	public PenalizacionDTO obtenerPenalizacion(PenalizacionDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPenalizacion():start");
		try {
	...
	public RangoAntiguedadDTO obtenerRangoAntiguedad(RangoAntiguedadDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerRangoAntiguedad():start");
		try {
	...
	*/
	...
	public RegCargosDTO construirRegistroCargos (com.tmmas.scl.framework.customerDomain.customerBillABE.dataTransferObject.ObtencionCargosDTO cargos) throws ManReqException {
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.construirRegistroCargos():start");
		try{
			MapperIF mapper2 = new DozerBeanMapper();
	...
	*/
	...
	public ResultadoRegCargosDTO parametrosRegistrarCargos(com.tmmas.scl.framework.productDomain.productOfferingABE.dataTransferObject.RegCargosDTO cargos) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.parametrosRegistrarCargos():start");
		try {
			MapperIF mapper2 = new DozerBeanMapper();
	...
	public RetornoDTO registrarVenta(IngresoVentaDTO venta) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.registrarVenta():start");
		try {
	...
	public RetornoDTO aceptarPresupuesto(PresupuestoDTO presup) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.aceptarPresupuesto():start");
		try {
	...
	public RetornoDTO consultarEstadoFacturado(long numProceso) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultarEstadoFacturado():start");
		try {
	...
	public ProductoContratadoListDTO obtenerProductosContratadosVenta(VentaDTO venta) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerProductosContratadosVenta():start");
		try {
	...
	public ProductoContratadoListDTO obtenerProductoContratado(OrdenServicioDTO ordenServicio) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerProductoContratado():start");
		try {
	...
	public ProductoOfertadoListDTO obtenerProductosOfertablesPorPaquete(PaqueteDTO paquete) throws GeneralException
	{
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerProductosOfertablesPorPaquete():start");
		try {
	...
	public ProductoOfertadoListDTO obtenerProductosOfertables(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerProductosOfertables():start");
		try {
	...
	public ServCuentaSegDTO tratarServCtaSeg(ServCuentaSegDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.tratarServCtaSeg():start");
		try {
	...
	public RetornoDTO registrarMovControlada(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.registrarMovControlada():start");
		try {
	...
	public PlanDTO consultaPlan(ConsultaPlanDTO consultaPlan) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultaPlan():start");
		try {
	...
	public ContratoDTO obtenerTipoContrato(ContratoDTO contrato) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerTipoContrato():start");
	...
	public ModalidadPagoDTO obtenerModalidadPago(ModalidadPagoDTO modalidad) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerModalidadPago():start");
	...
	public PresupuestoDTO obtenerDetallePresupuesto(PresupuestoDTO presup) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerDetallePresupuesto():start");
	...
	public BodegaListDTO obtenerListaBodegas(ConsultaBodegaDTO param) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerListaBodegas():start");
		try {
	...
	public RetornoDTO insertarConceptoDescuento(DescuentoDTO desc) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.insertarConceptoDescuento():start");
	...
	public DescuentoDTO obtenerCodConceptoDescuento(DatosGeneralesDTO param) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerCodConceptoDescuento():start");
	...
	public RetornoDTO eliminaCodConceptoDescuento(long numTransaccion) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.eliminaCodConceptoDescuento():start");
	...
	public ClienteDTO obtenerPlanComercial(ClienteDTO cliente) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerPlanComercial():start");
	...
	public PlanTarifarioDTO consultaPlanActual(ConsultaPlanTarifDTO consulta) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.consultaPlanActual():start");
		try {
	...
	public TipIdentListDTO obtenerTiposDeIdentidad() throws ManReqException{	
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerTiposDeIdentidad():start");
		try {
	...
	public ClienteListDTO buscarCliente(ClienteDTO cliente) throws  ManReqException {
		...
		log = System.getProperty("user.dir") + log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.buscarCliente():start");
		try {
	...
	public AbonadoDTO [] obtenerAbonados(String [] numAbonados) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerAbonados():start");
	...
	public AbonadoBeneficiarioListDTO obtieneAbonadosBeneficiariosPorNumCelular (AbonadoDTO abonadoDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtieneAbonadosBeneficiariosPorNumCelular():start");
		try {
	...
	public AbonadoBeneficiarioListDTO obtieneAbonadosBeneficiarios(AbonadoDTO abonadoDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtieneAbonadosBeneficiarios():start");
		try {
	...
	public MorosidadClienteDTO obtenerMorosidadCliente(MorosidadClienteDTO cliente)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerMorosidadCliente():start");
		try {
	...
	public LineasClienteDTO obtenerCantidadLineasCliente(LineasClienteDTO cliente)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCantidadLineasCliente():start");
		try {
	...
	public RespuestaEvalCrediticiaDTO validarEvaluacionCrediticia(EvalCrediticiaDTO data)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarEvaluacionCrediticia():start");
	...
	public IntarcelDTO obtenerFecDesdeCtaSeg(IntarcelDTO intarcel)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerFecDesdeCtaSeg():start");
		try {
	...
	public LimiteLineasDTO obtenerLimiteLineas(ObtencionLineasClienteDTO obtLineas)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerLimiteLineas():start");
		try {
	...
	public ObtencionRolUsuarioDTO obtenerRolUsuario(ObtencionRolUsuarioDTO obtRol)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerRolUsuario():start");
		try {
	...
	public CausaExcepcionListDTO obtenerCausaExcepcion() throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCausaExcepcion():start");
		try {
	...
	public NumeroDTO obtieneModificacionesProducto(ProductoContratadoDTO productoContratado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtieneModificacionesProducto():start");
		try {
	...
	public AbonadoListDTO obtenerListaAbonadosFiltrados(FiltroAbonadosDTO filtro) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerListaAbonadosFiltrados():start");
		try {
	...
	public RetornoDTO validaFiltroAbonados(ValidaFiltroAbonadosDTO filtro) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaFiltroAbonados():start");
		try {
	...
	public CuentaPersonalDTO obtenerNumeroPersonal(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerNumeroPersonal():start");
		try {
	...
	public int obtenerInfoPer(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerInfoPer():start");
		try {
	...
	public int validaPersonal(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaPersonal():start");
		try {
	...
	public int validaAtlantida(AbonadoDTO abonado)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaAtlantida():start");
		try {
	...
	public int validaAtlantidaCliente(ClienteDTO cliente)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaAtlantidaCliente():start");
		try {
	...
	public ClienteDTO obtenerCliente(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCliente():start");
		try {
	...
	public void validarActivarNumPer(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarActivarNumPer():start");
		try {
	...
	public int obtenerInfoAtl(CuentaPersonalDTO cuentaPersonalDTO)throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerInfoAtl():start");
		try {
	...
	public RetornoDTO validarClienteNPW (ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarClienteNPW():start");
		try {
    ...
    public RetornoDTO validarSituaCliEmp (ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarSituaCliEmp():start");
		try {
	...
	public PlanTarifarioDTO obtenerPlanTarifario(PlanTarifarioDTO plan) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPlanTarifario():start");
		try {
	...
	public RetornoDTO validarOriDesUso (AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarOriDesUso():start");
		try {
	...
	public ClienteDTO obtenerNumAbonadosCliente (ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.ManageRequestBussinessDelegate.obtenerNumAbonadosCliente():start");
		try {
	...
	public RetornoDTO validarSolicitudesBaja (AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarSolicitudesBaja():start");
		try {
	...
	public AbonadoDTO obtenerAbonadoEmpresa (ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerAbonadoEmpresa():start");
		try {
	...
	public ParametroSerializableDTO crearProceso(String numProceso) throws SupOrdHanException
	{
		...
		logger.debug("ManageRequestBussinessDelegate.crearProceso: start ");
	...
	public RetornoDTO registraNivelOoss(RegistroNivelOOSSDTO registraNivel) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.registraNivelOoss():start");
		try {
	...
	public RetornoDTO registrarOOSSEnLinea(RegistrarOossEnLineaDTO registraEnLinea) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.registrarOOSSEnLinea():start");
		try {
	...
	public RetornoDTO insertarCarta(CartaDTO carta) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.insertarCarta():start");
		try {
	...
	public RetornoDTO validarReversa (OrdenServicioDTO ordenServicioDto) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarReversa():start");
		try {
	...
	public RetornoDTO validarNumPer(AbonadoDTO abonado) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarNumPer():start");
		try {
	...
	public RegistroFacturacionDTO getDiasProrrateo(RegistroFacturacionDTO registro) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.getDiasProrrateo():start");
		try {
	...
	public RegistroFacturacionDTO aplicaImpuestoImporte(RegistroFacturacionDTO registro) throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.aplicaImpuestoImporte():start");
		try {
	...
	public int validarCarta(OrdenServicioDTO ordenServicio) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validarCarta():start");
		try {
	...
	public SecuenciaDTO[] obtenerNumeroDeSecuencias(CantSecuenciaDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerNumeroDeSecuencias():start");
		try {
	...
	public OficinaDTO obtenerDatosOficina(OficinaDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosOficina():start");
		try {
	...
	public EstadoProcesoOOSSDTO notificar(EstadoProcesoOOSSDTO estadoProcesoOOSS) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.notificar():start");
		try {
	...
	public AbonadoSecuenciaDTO[] obtenerSecuenciasAbonados(ObtencionSecuenciasDTO param) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerSecuenciasAbonados():start");
		try {
	...
	public com.tmmas.scl.vendedor.dto.VendedorDTO recuperarInformacionVendedor(com.tmmas.scl.vendedor.dto.VendedorDTO vendedor) throws ManReqException  {
		String log = global.getValor("web.log");
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.recuperarInformacionVendedor():start");
	...
	public ConfiguracionVendedorCPUDTO  recuperarConfiguracionVendedorCPU(ConfiguracionVendedorCPUDTO config) throws ManReqException {
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.recuperarConfiguracionVendedorCPU():start");
	...
	public UsuarioVendedorDTO  obtenerInformacionUsuarioVendedor(UsuarioSistemaDTO usuarioSistema) throws ManReqException {
		String log = global.getValor("web.log");
		PropertyConfigurator.configure(log);
		logger.debug("ManageRequestBussinessDelegate.obtenerInformacionUsuarioVendedor():start");
	...
	public LstPTaPlanTarifarioListOutDTO obtenerPlanesEvaluacion(ClienteDTO clienteOrigen) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPlanesEvaluacion():start");
	...
	public SalidaOutDTO bloqueaSolicitudEvRiesgo(long numSolicitud) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.bloqueaSolicitudEvRiesgo():start");
	...
	public SalidaOutDTO desBloqueaSolicitudEvRiesgo(long numSolicitud) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.desBloqueaSolicitudEvRiesgo():start");
	...
	public RetornoDTO actualizarLineasPorPlan (PlanEvaluacionRiesgoDTO planEval) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.actualizarLineasPorPlan():start");
		try {
	...
	public RetornoDTO validaBajaAtlEmpresa(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.validaBajaAtlEmpresa():start");
		try {
	...
	public Long obtenerNumClientesCuenta(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerNumClientesCuenta():start");
		try {
	...
	public ClienteListDTO listarClientesCuenta(ClienteDTO cliente) throws ManReqException{
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.listarClientesCuenta():start");
		try {
	...
	public CuentaPersonalDTO  obtieneNumeroCorporativo(CuentaPersonalDTO cuentaPersonal) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtieneNumeroCorporativo():start");
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
	...
	public CtaPersonalEmpDTO  obtenerDatosCtaPersonalCliEmp (CtaPersonalEmpDTO cuentaPersonal) throws ManReqException{
		logger.debug("ManageRequestBussinessDelegate.obtenerDatosCtaPersonalCliEmp():start");
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
	...
	public GedCodigosListDTO obtenerListaGedCodigos(GedCodigosDTO gedCodigosDTO) throws ManReqException {
		logger.debug("ManageRequestBussinessDelegate.obtenerListaGedCodigos():start");
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
	...
	public RetornoDTO getValidacionAbonadoCero(ParamCargosAbonadoCeroDTO param)throws ManReqException{
		
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		RetornoDTO codigos = null;
		
		logger.debug("getValidacionAbonadoCero():start");
		
		try {
			codigos = getSupOrdHanFacade().getValidacionAbonadoCero(param);
		}catch(ManReqException e){
			String loge = StackTraceUtl.getStackTrace(e);
			logger.debug("ManReqException[" + loge + "]");
			throw e;
...
//	INI-77866; COL; AVC; 09-02-2009
	/**
	 * -------------------  P R U E B A  -------------------
	 * Inserta datos del cambio de plan en la tabla <> para tener una respaldo de estos
	 * si falla el encolamiento del DTO
	 *   
	 * @param param
	 * @return RetornoDTO
	 * @throws ManReqException
	 ...
	 * 
	 */
	public RetornoDTO insertaTablaCola(RegistroColaDTO param)throws ManReqException{
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);
		
		logger.debug("insertaTablaCola():start");
		
		
		RetornoDTO retorno = null;
		
		try{
			logger.debug("inserta datos en Tabla");
			retorno = getCloCusOrdFacade().insertaTablaCola(param);
			logger.debug("registraNivelOoss() :fin");
		}catch(ManReqException e){
			String loge = StackTraceUtl.getStackTrace(e);
			logger.debug("ManReqException[" + loge + "]");
		...
		logger.debug("delegate.insertaTablaCola():fin");
		return retorno;
		
		
	}
    //	FIN-77866; COL; AVC; 09-02-2009

	/**
	 * Obtiene Prestaciones
	 * 
	 * @param 
	 * @return PrestacionListDTO
	 * @throws ManReqException
	 */
	public PrestacionListDTO obtenerPrestaciones() throws ManReqException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerPrestaciones():start");
		try {
	 ...
	 * @throws ManReqException
	 */
	public CausaCambioPlanListDTO obtenerCausasCambioPlan() throws ManReqException{	
	
		CausaCambioPlanListDTO resultado = null;
		String log = global.getValor("web.log");
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("ManageRequestBussinessDelegate.obtenerCausasCambioPlan():start");
		try {
			resultado = getSupOrdHanFacade().obtenerCausasCambioPlan();
		}catch(ManReqException e){
			String loge = StackTraceUtl.getStackTrace(e);
			logger.debug("ManReqException[" + loge + "]");
			throw e;
	...
	public PlanTarifarioDTO[] obtenerLimitesPlan(PlanTarifarioDTO entrada)	throws ManReqException {
		logger.debug("getLimitesConsumo():start");
		PlanTarifarioDTO[] retorno = null;
		try {
			retorno = getSupOrdHanFacade().obtenerLimitesPlan(entrada);
		} catch (ManReqException e) {
	...
	public CalificacionAbonadoDTO obtieneCalificacionAbonado(CalificacionAbonadoDTO abonado)	throws ManReqException {
		logger.debug("obtieneCalificacionAbonado():start");
		CalificacionAbonadoDTO retorno = null;
		try {
			retorno = getManConFacade().obtieneCalificacionAbonado(abonado);
		} catch (ManReqException e) {
			String log = StackTraceUtl.getStackTrace(e);
			logger.debug("ManReqException[" + log + "]");
			throw e;
