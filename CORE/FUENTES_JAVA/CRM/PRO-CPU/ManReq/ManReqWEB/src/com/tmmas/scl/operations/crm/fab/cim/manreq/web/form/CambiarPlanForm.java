...
public class CambiarPlanForm extends ActionForm {
	...
	private String causaCambioCB;
	
	//(+)Limite de consumo , EV 07/12/09
	private double montoLimiteConsumo;
	private double montoMinimo;
	private double montoMaximo;
	private int flgCorte;
	private double montoCons;
	private double montoLimiteIngresado;
	private String aplicaPrecalificacion="N";

	public String getAplicaPrecalificacion() {
		return aplicaPrecalificacion;
	}
	public void setAplicaPrecalificacion(String aplicaPrecalificacion) {
		this.aplicaPrecalificacion = aplicaPrecalificacion;
	}
	public double getMontoLimiteIngresado() {
		return montoLimiteIngresado;
	}
	public void setMontoLimiteIngresado(double montoLimiteIngresado) {
		this.montoLimiteIngresado = montoLimiteIngresado;
	}
	//(-)
	...
	public String getCausaCambioCB() {
		return causaCambioCB;
	}
	public void setCausaCambioCB(String causaCambioCB) {
		this.causaCambioCB = causaCambioCB;
	}
