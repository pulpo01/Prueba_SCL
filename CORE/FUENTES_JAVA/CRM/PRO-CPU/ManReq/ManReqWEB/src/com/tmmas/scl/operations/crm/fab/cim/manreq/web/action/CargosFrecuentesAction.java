...
public class CargosFrecuentesAction extends BaseAction{
	
	private final Logger logger = Logger.getLogger(CargosFrecuentesAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		logger.debug("No se cobran cargos de negocio para Personalizacion de Frecuentes");
