package com.tmmas.scl.operations.crm.f.oh.isscusord.limiteconsumo.abono.cmd.properties;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.f.oh.isscusord.limiteconsumo.abono.cmd.properties.cmdAboLC");
		}
		return instance;
	}
