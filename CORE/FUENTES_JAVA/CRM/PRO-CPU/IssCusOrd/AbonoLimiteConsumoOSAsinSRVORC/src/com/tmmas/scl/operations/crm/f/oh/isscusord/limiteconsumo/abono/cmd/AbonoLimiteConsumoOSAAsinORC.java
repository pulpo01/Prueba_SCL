package com.tmmas.scl.operations.crm.f.oh.isscusord.limiteconsumo.abono.cmd;
...
public class AbonoLimiteConsumoOSAAsinORC extends OrdenServicioAsincronoCmdORC{

	private static final long serialVersionUID = 1L;

	transient static Logger cat = Logger.getLogger(AbonoLimiteConsumoOSAAsinORC.class);
	...
	public AbonoLimiteConsumoOSAAsinORC() {
		// TODO Auto-generated constructor stub
	}

	public AbonoLimiteConsumoOSAAsinORC(AsyncProcessParameterObject value) {
		super(value);
		// TODO Auto-generated constructor stub
	}
	...
	throws IssCusOrdException {
		cat.debug("ejecutarAbonoLimiteConsumo():start");		

		try{
			registroOrden((ParamAbonoLimiteConsumoDTO) objeto);
		} catch (IssCusOrdException e) {
			throw e;
		}
		cat.debug("ejecutarAbonoLimiteConsumo():end");	
	}


	//ParamRegistroOrdenServicioDTO
	public void registroOrden(ParamAbonoLimiteConsumoDTO objeto) throws IssCusOrdException
	{
		cat.debug("registroOrden():start");
		
		AbonoLimiteConsumoListDTO listaAboLC = objeto.getListaAbonosLc();
		...
		try{
			...
			if(listaAboLC.getAbonoDto().length > 0)
			{
			
				ejecutarAbonoLc(listaAboLC);
	...
	private void ejecutarAbonoLc(AbonoLimiteConsumoListDTO listaAboLC)throws IssCusOrdException {
	
		cat.debug("ejecutarAbonoLc():start");		
		...
		{		
			...
			retorno = service1.abonoLimiteDeConsumo(listaAboLC);
		}catch(IssCusOrdException e)
		{
			throw e;
		}		
		cat.debug("ejecutarAbonoLc():end");	
	}
	

	private void ejecutarRegistroOrden(ParamAbonoLimiteConsumoDTO param) throws CloCusOrdException{
