package com.tmmas.scl.operations.crm.f.oh.isscusord.srv.soa.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.f.oh.isscusord.srv.soa.properties.serviceSoa");
		}
		return instance;
	}
}
