...
/**
 * Utility class for OrdenServicioMDB.
 * @generated 
 * @wtp generated
 */
public class OrdenServicioMDBUtil
{
  ...
  private static final java.lang.String DESTINATION_JNDI_NAME="OrdenServicioMDB";
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";

   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Queue for OrdenServicioMDB. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for OrdenServicioMDB. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("OrdenServicioMDBUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
