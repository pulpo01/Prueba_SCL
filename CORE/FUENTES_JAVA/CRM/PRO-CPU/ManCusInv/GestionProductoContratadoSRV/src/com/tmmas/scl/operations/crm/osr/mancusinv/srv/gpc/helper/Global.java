package com.tmmas.scl.operations.crm.osr.mancusinv.srv.gpc.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.osr.mancusinv.srv.gpc.properties.service");
		}
		return instance;
	}	
}
