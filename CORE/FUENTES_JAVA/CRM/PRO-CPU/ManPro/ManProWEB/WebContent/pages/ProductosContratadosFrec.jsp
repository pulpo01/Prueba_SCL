  ...
  <tr>
    ...
    <td colspan="3" align="left">
		...
		<tr>
	      ...
	      <tr>
	        <td width="100%" colspan="7" align="left" ><h2 class="textoSubTitulo"> Planes Adicionales Contratados con N&uacute;meros Frecuentes</h2></td>
	      </tr>
	      <tr>
	        ...
	        <td colspan="7">&nbsp;</td>
  			...
  			<tr>
				...
				<logic:present name="ProductoContratadoFrecList" scope="session">
	   			<bean:define id="productosContratadosFrec" name="ProductoContratadoFrecList" type="com.tmmas.scl.operations.crm.f.s.manpro.frmk.dataTransferObject.ProductoContratadoFrecDTO[]"/>
	   			<logic:iterate indexId="count" id="productoContratadoFrec" name="productosContratadosFrec"  type="com.tmmas.scl.operations.crm.f.s.manpro.frmk.dataTransferObject.ProductoContratadoFrecDTO">
				<%colorFila = null;
