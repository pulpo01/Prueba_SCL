...
function existeNumeroFrecIngresado()
{
	...
	if(numero == numCelAbonado)
	{
		muestraMensajeErr("El n\u00FAmero ingresado no puede ser el celular del abonado contratante");
		return true;
	}
	...
	document.getElementById('ingresar').enabled=true;
	return false;
}
