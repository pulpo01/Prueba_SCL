...
public class CargoWebDTO extends CargoDTO
{
	...
	{		
		 ...
		 this.tipoCobro=cargo.getTipoCobro();
		 this.impuesto=cargo.getImpuesto();
		 this.setDescuentos(cargo.getDescuentos());
	}

	public boolean isAplicaDesc() {
		return isAplicaDesc;
	}

	public void setAplicaDesc(boolean isAplicaDesc) {
		this.isAplicaDesc = isAplicaDesc;
	}
}
