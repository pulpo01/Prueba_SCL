package com.tmmas.scl.operations.crm.b.bcm.mancusbil.bean.ejb.helper;
...
public class Global extends GlobalBase implements Serializable{
	...
	public static synchronized Global getInstance() {
		if (instance == null) {
			instance = new Global("com.tmmas.scl.operations.crm.b.bcm.mancusbil.bean.ejb.properties.negocio");
		}
		return instance;
	}	
}
