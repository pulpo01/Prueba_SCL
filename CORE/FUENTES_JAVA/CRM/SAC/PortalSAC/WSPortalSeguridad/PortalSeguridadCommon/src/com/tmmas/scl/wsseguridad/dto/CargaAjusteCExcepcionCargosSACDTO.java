 ...
 *
 * Fecha ------------------- Autor  ------------------------- Cambios ----------
 * 12/03/2008 - 16:05:05     Santiago Ventura      			Versión Inicial 
 * 
 *
 * Clase que representa la carga de una orden de servicio de ajuste con excepci&oacute;n cargos.
 * 
 * @author Santiago Ventura
 * @version 1.0
 * 
 **/
public class CargaAjusteCExcepcionCargosSACDTO implements Serializable {
	...
	/**
	 * Array que contiene el listado de tipo de ajuste para la emisi&oacute;n de notas de cr&eacute;dito internas.
	 */
	private NotaCreditoVO[] arrayNotaCreditoVO;
	 ...
	 * 
	 */
	public CargaAjusteCExcepcionCargosSACDTO() {
	...
	/**
	 * @return NotaCreditoVO[] the arrayNotaCreditoVO 
	 */
	public NotaCreditoVO[] getArrayNotaCreditoVO() {
		return arrayNotaCreditoVO;
	}

	/**
	 * @param arrayNotaCreditoVO NotaCreditoVO[] the arrayNotaCreditoVO to set
	 */
	public void setArrayNotaCreditoVO(NotaCreditoVO[] arrayNotaCreditoVO) {
		this.arrayNotaCreditoVO = arrayNotaCreditoVO;
	}
