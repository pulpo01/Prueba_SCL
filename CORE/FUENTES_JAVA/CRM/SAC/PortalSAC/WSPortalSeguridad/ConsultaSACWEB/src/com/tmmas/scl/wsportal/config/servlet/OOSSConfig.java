...
public class OOSSConfig extends ConfigBaseServlet implements javax.servlet.Servlet
{
	private static Logger logger = Logger.getLogger(OOSSConfig.class);

	private static final long serialVersionUID = -4067068653801898206L;

	private static final String RUTA_NOMBRE_ARCHIVO = RUTA_ARCHIVOS + "/OOSS.config.xml";
