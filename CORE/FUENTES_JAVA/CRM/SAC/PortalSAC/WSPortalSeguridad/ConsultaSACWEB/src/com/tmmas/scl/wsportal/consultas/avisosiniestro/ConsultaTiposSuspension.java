...
/**
 * Servlet implementation class for Servlet: ConsultaTiposSuspension
 *
 */
 public class ConsultaTiposSuspension extends com.tmmas.scl.wsportal.consultas.servlet.base.ConsultasBaseServlet implements javax.servlet.Servlet {
    /**
	 * 
	 */
	private static final long serialVersionUID = -7171621316889686192L;
	
	private static Logger logger = Logger.getLogger(ConsultaTiposSuspension.class);

	/* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ConsultaTiposSuspension() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ListadoTiposSuspensionDTO r = null;
