...
/**
 * Servlet implementation class for Servlet: ConsultaCausasSiniestro
 * 
 */
public class ConsultaCausasSiniestro extends com.tmmas.scl.wsportal.consultas.servlet.base.ConsultasBaseServlet
		implements javax.servlet.Servlet
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -4027502565865828619L;
	 ...
	 */
	private static Logger logger = Logger.getLogger(ConsultaCausasSiniestro.class);

	public ConsultaCausasSiniestro()
	{
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		ListadoCausasSiniestroDTO r = null;
