...
public class ConsultasConfig extends ConfigBaseServlet implements javax.servlet.Servlet
{
	private static Logger logger = Logger.getLogger(ConsultasConfig.class);

	private static final long serialVersionUID = -4067068653801898206L;

	private static final String RUTA_NOMBRE_ARCHIVO = RUTA_ARCHIVOS + "/Consultas.config.xml";
