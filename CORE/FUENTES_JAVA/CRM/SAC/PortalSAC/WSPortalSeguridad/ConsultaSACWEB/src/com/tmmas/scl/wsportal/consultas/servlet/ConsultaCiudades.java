...
/**
 * Servlet implementation class for Servlet: ConsultaCiudades
 * 
 */
public class ConsultaCiudades extends com.tmmas.scl.wsportal.consultas.servlet.base.ConsultasBaseServlet implements
		javax.servlet.Servlet
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -6041969143336451213L;

	private static Logger logger = Logger.getLogger(ConsultaCiudades.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			r = srv.obtenerCiudades(codRegion, codProvincia);
