...
public class OverrideSolicitudForm extends ActionForm {
	...
	private String valoresOverrideTabla;

	private boolean aplicaOverrideSolicitud;

	private boolean aplicaOverrideFormalizacion;
	
	private boolean activarOverride;
	...
	public final String getCodModuloOrigen() {
		return codModuloOrigen;
	}

	public final void setCodModuloOrigen(String codModuloOrigen) {
	...
	public final String getValoresOverrideTabla() {
		return valoresOverrideTabla;
	}

	public final void setValoresOverrideTabla(String valoresOverride) {
		this.valoresOverrideTabla = valoresOverride;
	}
	...
	public final void setMensajeError(String mensaje) {
	...
	public final boolean isAplicaOverrideSolicitud() {
		return aplicaOverrideSolicitud;
	}

	public final void setAplicaOverrideSolicitud(boolean activarOverride) {
		this.aplicaOverrideSolicitud = activarOverride;
	}

	public final boolean isAplicaOverrideFormalizacion() {
		return aplicaOverrideFormalizacion;
	}

	public final void setAplicaOverrideFormalizacion(boolean activarOverrideFormalizacion) {
		this.aplicaOverrideFormalizacion = activarOverrideFormalizacion;
	}

	public final boolean isActivarOverride() {
		return activarOverride;
	}

	public final void setActivarOverride(boolean activarOverride) {
		this.activarOverride = activarOverride;
	}
