...
public class RegistroEvaluacionRiesgoComDTO implements Serializable{
	...
	public ClienteComDTO getCliente() {
		return clienteCom;
	}
	public void setCliente(ClienteComDTO clienteCom) {
