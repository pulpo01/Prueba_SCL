...
public class ReglasServiciosSuplementarios extends ReglaListaPrecio{
	...
	private static Category cat = Category.getInstance(ReglasServiciosSuplementarios.class);
	private ParametrosReglasServicioSuplementarioDTO parametrosRegla = new ParametrosReglasServicioSuplementarioDTO();
	...
	public PrecioDTO[] seleccionPrecios() throws ProductDomainException{
		...
		if(parametrosRegla.getEsCargoInstalacion().trim().equals("1"))
		{
			arregloPreciosCargos = servicioSuplementarioBO.getCargoServSuplCargoInstalacion(servicioSuplementario);
		}else{
