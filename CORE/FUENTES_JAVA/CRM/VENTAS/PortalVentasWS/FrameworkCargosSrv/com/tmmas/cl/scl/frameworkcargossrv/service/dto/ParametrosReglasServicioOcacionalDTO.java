...
public class ParametrosReglasServicioOcacionalDTO extends ParametrosReglaDTO {
	...
	private int indicadorInstalacion;
	
	
	
	public int getIndicadorInstalacion() {
		return indicadorInstalacion;
	}

	public void setIndicadorInstalacion(int indicadorInstalacion) {
		this.indicadorInstalacion = indicadorInstalacion;
	}
