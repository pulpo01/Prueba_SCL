...
public class Global implements Serializable{
	...
	private final String archivoRecurso = "com.tmmas.cl.scl.altacliente.presentacion.properties.altaclienteweb";
	...
	public String getValorExterno(String valorClave) {
		String valor = configExterno.getString(valorClave);
		return valor;
	}
}
