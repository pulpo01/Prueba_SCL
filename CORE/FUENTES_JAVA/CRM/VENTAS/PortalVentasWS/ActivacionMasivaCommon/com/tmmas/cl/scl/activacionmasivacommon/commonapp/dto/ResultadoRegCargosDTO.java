...
public class ResultadoRegCargosDTO implements Serializable{
	...
	private FormadePagoDTO[] arregloFormasdePago;
	
	public FormadePagoDTO[] getArregloFormasdePago() {
		return arregloFormasdePago;
	}
	public void setArregloFormasdePago(FormadePagoDTO[] arregloFormasdePago) {
