...
public class DocumentoDAO extends ConnectionDAO{
	 ...
	 */
	public DocumentoDTO[] getListadoTipoDocumento(DatosComercialesDTO datos) 
		throws CustomerDomainException
	{
		...
		try {
			...
			throw new CustomerDomainException(
					"Ocurrió un error al consultar el tipo de Documento",e);
		} finally {
		 	if (cat.isDebugEnabled()) 
	...
	public DocumentoFacturacionDTO getPromedioDocumentosFacturados(DocumentoFacturacionDTO entrada)
		throws CustomerDomainException
	{
