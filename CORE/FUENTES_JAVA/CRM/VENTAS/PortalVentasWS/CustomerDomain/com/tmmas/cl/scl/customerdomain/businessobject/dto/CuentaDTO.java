...
public class CuentaDTO implements Serializable {
	...
	public int getExisteSubCuenta() {
		return existeSubCuenta;
	}
	public void setExisteSubCuenta(int existeSubCuenta) {
		this.existeSubCuenta = existeSubCuenta;
	}
