...
public class GaVentasDTO implements Serializable {
	...
	private Long numVenta;//NOT NULL,
	  ...
	  private Timestamp fecVenta;//NOT NULL,
	  ...
	  private Long tipValor;//NUMBER(2),
	  ...
	  private Date fecCumplimenta;//DATE,
	  ...
	  //-- Preactivacion (si se debe preactivar o no las lineas)
	...
	public Date getFecCumplimenta() {
		return fecCumplimenta;
	}
	public void setFecCumplimenta(Date fecCumplimenta) {
	...
	public Timestamp getFecVenta() {
		return fecVenta;
	}
	public void setFecVenta(Timestamp fecVenta) {
