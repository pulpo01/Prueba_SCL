...
public class ParametrosValidacionLogisticaDTO extends ParametrosValidacionDTO{
	...
	public ParametrosValidacionLogisticaDTO(ParametrosValidacionDTO inicia){
		...
		this.setLargoSerieSimcard(inicia.getLargoSerieSimcard());
		this.setLargoSerieTerminal(inicia.getLargoSerieTerminal());
		this.setEstadoNuevoSimcard(inicia.getEstadoNuevoSimcard());
		this.setUsoVentaHibrido(inicia.getUsoVentaHibrido());
		this.setUsoVentaPostpago(inicia.getUsoVentaPostpago());
		this.setCodigoCanal(inicia.getCodigoCanal());
