...
public class ReglasServiciosSuplementariosCOL extends ReglaListaPrecio{

	private final Logger logger = Logger.getLogger(ReglasServiciosSuplementariosCOL.class);
	...
	public ReglasServiciosSuplementariosCOL(ParametrosReglasServicioSuplementarioDTO parametros) {
		super(parametros);
