...
public class ReglasBajaOptaPrepagoBajaAbonado extends ReglaListaPrecio{
	...
	public ReglasBajaOptaPrepagoBajaAbonado(ParametrosReglasBajaOptaPrepagoBajaAbonadoDTO parametros) {
		super(parametros);
