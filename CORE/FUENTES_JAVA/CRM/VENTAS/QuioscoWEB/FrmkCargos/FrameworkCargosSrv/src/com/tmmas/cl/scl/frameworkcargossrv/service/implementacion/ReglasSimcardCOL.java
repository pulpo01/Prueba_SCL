...
public class ReglasSimcardCOL extends ReglaListaPrecio{

	private final Logger logger = Logger.getLogger(ReglasSimcardCOL.class);
	...
	public ReglasSimcardCOL(ParametrosReglasSimcardDTO parametros) {
		super(parametros);
