...
public class ReglasBajaOptaPrepagoIndemnizacion extends ReglaListaPrecio{
	...
	public ReglasBajaOptaPrepagoIndemnizacion(ParametrosReglasBajaOptaPrepagoIndemnizacionDTO parametros) {
		super(parametros);
...
//			TODO: Cargos por Equipo                                                                                                                       
	        ...
	        String indComodato=parametrosRegla.getInd_Comodato();                                                                                    
	        ...
	        if (indComodato.equals(Global.getValor("parametro.comodato"))){                                                                          
	        	...
	        	String codEstadoDev=parametrosRegla.getCod_Estado_dev();                                                                          
	        	...
	        	if (!codEstadoDev.equals(Global.getValor("codigo.devolucion.equipo.D"))){                                                        
					...
					cargosDevlEquipoAccesorioQTDTO.setCod_Estado_Dev(parametrosRegla.getCod_Estado_dev());                            
