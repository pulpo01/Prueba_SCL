...
public class ReglasServiciosOcasionalesCOL extends ReglaListaPrecio{

	private final Logger cat = Logger.getLogger(ReglasServiciosOcasionalesCOL.class);
    ...
    public ReglasServiciosOcasionalesCOL(ParametrosReglasServicioOcacionalDTO parametros) {
		super(parametros);
