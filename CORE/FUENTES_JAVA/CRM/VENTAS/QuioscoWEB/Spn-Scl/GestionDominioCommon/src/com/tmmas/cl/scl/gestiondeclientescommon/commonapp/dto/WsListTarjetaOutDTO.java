...
public class WsListTarjetaOutDTO extends RetornoDTO implements Serializable {
	
	private static final long serialVersionUID = 1L;

	private WsTarjetaOutDTO[] wsTarjetaArrOutDTO;
	...
	public WsTarjetaOutDTO[] getWsTarjetaArrOutDTO() {
		return wsTarjetaArrOutDTO;
	}

	public void setWsTarjetaArrOutDTO(WsTarjetaOutDTO[] wsTarjetaArrOutDTO) {
