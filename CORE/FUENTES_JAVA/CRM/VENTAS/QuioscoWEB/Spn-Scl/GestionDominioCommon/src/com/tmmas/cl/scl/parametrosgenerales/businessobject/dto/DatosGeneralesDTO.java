...
public class DatosGeneralesDTO implements Serializable{
	...
	private boolean bResultadoValidacion;
	
		
	public boolean isBResultadoValidacion() {
		return bResultadoValidacion;
	}
	public void setBResultadoValidacion(boolean resultadoValidacion) {
		bResultadoValidacion = resultadoValidacion;
	}
