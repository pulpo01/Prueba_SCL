...
public class Global implements Serializable {
	...
	private final String archivoRecurso = "com.tmmas.scl.serviciospostventasiga.common.properties1.businessobject";
	...
	public String errorgetListado() {
		return this.recurso
				.obtenerValorClave("error.getListado.procesaRespuesta");
	}
	...
	public int getValorCodigoProducto() {
		return Integer.parseInt(this.recurso
				.obtenerValorClave("valor.codigo.producto"));
	}

	public String getValorColumnaContCel() {
		return this.recurso.obtenerValorClave("valor.columna.ind_contcel");
	}

	public String getValorColumnaContSeg() {
		return this.recurso.obtenerValorClave("valor.columna.ind_contseg");
	}
	...
	public String getEstadoVigenteEvaluacionRiesgo() {
		return this.recurso
				.obtenerValorClave("estado.vigente.evaluacionriesgo");
	}

	public int getIndicadorEvento() {
		return Integer.parseInt(this.recurso
				.obtenerValorClave("indicador.evento"));
	}

	public int getTipoSolicitud() {
		return Integer.parseInt(this.recurso
				.obtenerValorClave("tipo.solicitud"));
	}
	...
	public String getIndicadorPropiedadC() {
		return this.recurso.obtenerValorClave("indicador.propiedadC");
	}

	public String getIndicadorPropiedadE() {
		return this.recurso.obtenerValorClave("indicador.propiedadE");
	}

	public String getIndicadorEquiAcc() {
		return this.recurso.obtenerValorClave("indicador.equiacc");
	}

	public String getCodigoTecnoGsm() {
		return this.recurso.obtenerValorClave("codigo.tecnologia.gsm");
	}
