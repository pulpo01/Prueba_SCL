...
public class WsListBancoOutDTO extends RetornoDTO implements Serializable {
	
	private static final long serialVersionUID = 1L;

	private WsBancoOutDTO[] wsBancoArrOutDTO;
	...
	public WsBancoOutDTO[] getWsBancoArrOutDTO() {
		return wsBancoArrOutDTO;
	}

	public void setWsBancoArrOutDTO(WsBancoOutDTO[] wsBancoArrOutDTO) {
