...
public class RetornoDTO  implements java.io.Serializable {
    ...
    /**
     * Gets the codError value for this RetornoDTO.
     * 
     * @return codError
     */
    ...
    /**
     * Sets the codError value for this RetornoDTO.
     * 
     * @param codError
     */
    ...
    /**
     * Gets the mensajseError value for this RetornoDTO.
     * 
    ...
    /**
     * Sets the mensajseError value for this RetornoDTO.
     * 
     * @param mensajseError
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.gestiondeclientescommon.commonapp.dto", "RetornoDTO"));
