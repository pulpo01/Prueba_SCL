/**
 * WsCunetaAltaDeLineaOutDTO.java
 *
...
public class WsCunetaAltaDeLineaOutDTO  implements java.io.Serializable {
    private dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO[] errores;
    ...
    public WsCunetaAltaDeLineaOutDTO() {
    }

    public WsCunetaAltaDeLineaOutDTO(
           dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO[] errores,
    ...
    /**
     * Gets the errores value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @return errores
     */
    public dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO[] getErrores() {
        return errores;
    }


    /**
     * Sets the errores value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @param errores
     */
    public void setErrores(dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO[] errores) {
        this.errores = errores;
    }

    public dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO getErrores(int i) {
        return this.errores[i];
    }

    public void setErrores(int i, dto.commonapp.gestiondeclientescommon.scl.cl.tmmas.com.RetornoLineaDTO _value) {
        this.errores[i] = _value;
    }


    /**
     * Gets the lineaOut value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @return lineaOut
     */
    ...
    /**
     * Sets the lineaOut value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @param lineaOut
     */
    ...
    /**
     * Gets the numVenta value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @return numVenta
     */
    ...
    /**
     * Sets the numVenta value for this WsCunetaAltaDeLineaOutDTO.
     * 
     * @param numVenta
     */
    ...
    /**
     * Gets the resultadoTransaccion value for this WsCunetaAltaDeLineaOutDTO.
     * 
    ...
    /**
     * Sets the resultadoTransaccion value for this WsCunetaAltaDeLineaOutDTO.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsCunetaAltaDeLineaOutDTO)) return false;
        WsCunetaAltaDeLineaOutDTO other = (WsCunetaAltaDeLineaOutDTO) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WsCunetaAltaDeLineaOutDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.commonapp.dto", "WsCunetaAltaDeLineaOutDTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.gestiondeclientescommon.commonapp.dto", "RetornoLineaDTO"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.commonapp.dto", "LineaOut"));
