...
public class WsDireccionOutDTO  implements java.io.Serializable {
    ...
    public WsDireccionOutDTO() {
    }

    public WsDireccionOutDTO(
           java.lang.String codigoDireccion,
    ...
    /**
     * Gets the codigoDireccion value for this WsDireccionOutDTO.
     * 
    ...
    /**
     * Sets the codigoDireccion value for this WsDireccionOutDTO.
     * 
    ...
    /**
     * Gets the errores value for this WsDireccionOutDTO.
     * 
     * @return errores
     */
    ...
    /**
     * Sets the errores value for this WsDireccionOutDTO.
     * 
     * @param errores
     */
    ...
    /**
     * Gets the resultadoTransaccion value for this WsDireccionOutDTO.
     * 
    ...
    /**
     * Sets the resultadoTransaccion value for this WsDireccionOutDTO.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsDireccionOutDTO)) return false;
        WsDireccionOutDTO other = (WsDireccionOutDTO) obj;
        ...
        boolean _equals;
        _equals = true && 
            ((this.codigoDireccion==null && other.getCodigoDireccion()==null) || 
             (this.codigoDireccion!=null &&
              this.codigoDireccion.equals(other.getCodigoDireccion()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCodigoDireccion() != null) {
            _hashCode += getCodigoDireccion().hashCode();
        }
        if (getErrores() != null) {
            for (int i=0;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WsDireccionOutDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.commonapp.dto", "WsDireccionOutDTO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codigoDireccion");
        elemField.setXmlName(new javax.xml.namespace.QName("java:com.tmmas.cl.scl.commonapp.dto", "CodigoDireccion"));
