...
/**
 * Utility class for TraspasoMasivoMDB.
 * @generated 
 * @wtp generated
 */
public class TraspasoMasivoMDBUtil
{
  ...
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";
    ...
    * @return Destination JMS Queue for TraspasoMasivoMDB. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for TraspasoMasivoMDB. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("TraspasoMasivoMDBUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
