package com.tmmas.cl.scl.integracionexterna.common.exception;
 ...
 * 
 **/
public class IntegracionExternaException extends Exception {
    ...
    public IntegracionExternaException() {

        super();
    }

    public IntegracionExternaException(String pMessage) {

        super(pMessage);
        this.message = pMessage;
    }
    
    public IntegracionExternaException(String pCodigo, int pCodigoEvento, String pDescripcionEvento) {
        super();
    ...
    public IntegracionExternaException(String pCodigo, int pCodigoEvento) {
        super();
