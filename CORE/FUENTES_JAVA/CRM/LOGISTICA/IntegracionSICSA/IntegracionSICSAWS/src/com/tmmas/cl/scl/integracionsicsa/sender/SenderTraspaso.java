...
public class SenderTraspaso {
	...
	public SenderTraspaso() throws IntegracionSICSAException {
		init();
	}
	...
	private void init() throws IntegracionSICSAException{
		try {
			...
			Queue queue = (Queue) jndiContext.lookup(global.getValorExterno("GE.jndi.queue.traspaso"));
