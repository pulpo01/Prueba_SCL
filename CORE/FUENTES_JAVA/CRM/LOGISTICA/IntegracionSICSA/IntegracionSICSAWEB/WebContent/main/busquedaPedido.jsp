...
function buscarDetallePedido(pedido){
	document.getElementById("codPedidoBusc").value=pedido;
	enviarForm("formBusquedaDetallePedido");
}
...
function mostrarSeries(linPedido, nomArticulo){
	document.getElementById("linPedidoBusc").value=linPedido;
...
function exportarTXT(linPedido){
	...
	document.getElementById("formBusquedaDetallePedido").submit();
...
<body>
<html:form styleId="formBusquedaPedido" method="post"
	action="/action/BuscaPedidoAction" target="ctrl">
	<center><img src="../images/cargando.gif" id="cargando" style="display: none"></center>
	<br>
	<label class="txtTitulo">Pedidos
			realizados por <bean:write name="usuarioDTO" property="nomUsuario" />
	...
	<table align="left" border=0 height="auto" style="margin-left: 0%" width="15%">
		...
		<tr>
			<th class="detalle" align="left" valign="top">Número de Pedido</th>
		</tr>
		<tr>
			<td class="detalle" colspan="1"><input class="campoText"
				type="text" size="10" name="txtPedido" id="txtPedido" onkeypress="return soloNumeros(event)" /><br>
			<br>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="detalle" colspan="1" align="center" valign="top"><input
				...
				onclick="buscarPedidos();" value="Buscar Pedido" class="barraarriba" />
...
<br>
	...
	<br>
	<div id="dv-pedidos" class="divDatos">
