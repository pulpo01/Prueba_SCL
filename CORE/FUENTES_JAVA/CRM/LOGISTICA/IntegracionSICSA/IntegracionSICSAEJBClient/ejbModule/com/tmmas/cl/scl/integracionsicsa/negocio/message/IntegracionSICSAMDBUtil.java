...
/**
 * Utility class for IntegracionSICSAMDB.
 * @generated 
 * @wtp generated
 */
public class IntegracionSICSAMDBUtil
{
  ...
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";
    ...
    * @return Destination JMS Queue for IntegracionSICSAMDB. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for IntegracionSICSAMDB. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("IntegracionSICSAMDBUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
