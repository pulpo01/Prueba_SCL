...
public class CargaSeguimientoSiniestroOutDTO extends GestionLimiteConsumoOutDTO implements Serializable {
    ...
    /**
     * @param lonNumTerminal
     *            the lonNumTerminal to set
     */
