package com.tmmas.scl.gestionlc.common.helper;
...
//import com.tmmas.cl.scl.spnscl.common.dto.ws.SpnSclOutDTO;
...
public final class LoggerHelper {
    ...
    private LoggerHelper() {
        ...
        try {
             ...
             * log4j
             */
            String rutaPropsfile = global.getValor("GE.log.aplicacion.GE");
            rutaPropsfile = System.getProperty("user.dir") + "/" + rutaPropsfile;
            ...
            FileInputStream inputStream = new FileInputStream(new File(rutaPropsfile));
            ...
            logger3.debug("ERROR creando instancia Singleton de LogHelper " + "\n" + e.getMessage());
        }
    }
    ...
    /**
     * Imprime solo valores: cod error, desc. error y Evento para el DTO
     * SpnSclOutDTO (heredado por todos los DTO)
     * 
     * @param spnDTO
     */
    public void imprimeDTO(GestionLimiteConsumoOutDTO outDTO) {
        logger3.error("");
        logger3.error("Cod. Error: " + outDTO.getStrCodError());
        logger3.error("Desc. Error:" + outDTO.getStrDesError());
        logger3.error("Evento: " + outDTO.getIEvento());
        logger3.error("");
    }
    ...
    public static void imprimirPropiedades(Object obj) {
        Logger logger3 = Logger.getLogger("LoggerHelper");
        logger3.debug("");
