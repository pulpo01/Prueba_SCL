...
public class EjecucionRestitucionEquipoInDTO implements Serializable {
	...
	/**
	 * @param lonNumSiniestro the lonNumSiniestro to set
	 */
	...
	/**
	 * @param strFecRestitucion the strFecRestitucion to set
	 */
	...
	/**
	 * @param lonNumConstancia the lonNumConstancia to set
	 */
	...
	/**
	 * @param shoCantSiniestros the shoCantSiniestros to set
	 */
	...
	/**
	 * @param lonNumAbonado the lonNumAbonado to set
	 */
