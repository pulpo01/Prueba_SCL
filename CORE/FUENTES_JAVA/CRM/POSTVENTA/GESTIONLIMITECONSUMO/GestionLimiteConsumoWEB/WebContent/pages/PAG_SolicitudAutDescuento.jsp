...
<html:hidden name="SolicitudAutDescuentoForm" property="estadoSolicitudGlosa"/>
...
<table width="100%" border="0">
  ...
  <tr>
     <td colspan="5"><p class="style1">El monto de descuento aprobado para Ud. est&aacute; fuera de los l&iacute;mites autorizados,<br />
      ...
      <p class="style1">Si desea salir de la aplicaci&oacute;n presione el bot&oacute;n &ldquo;SALIR&rdquo;.</p>
     </td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td>
  ...
  <tr>
    ...
    <td>
    	<html:text style="alignTextboxDerecha" tabindex="1" name="SolicitudAutDescuentoForm" property="numAutorizacion" readonly="true"/>
    </td>
    <td> 
