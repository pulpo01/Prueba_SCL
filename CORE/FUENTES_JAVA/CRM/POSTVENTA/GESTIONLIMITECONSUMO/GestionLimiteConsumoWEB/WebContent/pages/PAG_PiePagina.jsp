<table width="100%" border="0">
  <tr>
	...
	onmouseover="sobreElBoton('Siguiente1','../botones/btn_siguiente_roll.gif')" onMouseOut="sobreElBoton('Siguiente1','../botones/btn_siguiente.gif')" onclick="doSubmitBotones('SIGUIENTE');" />
