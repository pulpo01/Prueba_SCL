...
<input type="hidden" id="indCreaDescuento" name="total" value="<bean:write name="indCreaDesc"/>"/>
<input type="hidden" id="rangoInfPorcDescuento" name="total" value="<bean:write name="rangoInf"/>"/>
<input type="hidden" id="rangoSupPorcDescuento" name="total" value="<bean:write name="rangoSup"/>"/>
<input type="hidden" id="numDecimalesForm" name="numDecimalesForm" value="<bean:write name="numDecimalesFormulario"/>"/>
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="162" class="valorCampoSeleccionable">
          ...
          <%boolean Hab_CargosCicloRB = Boolean.valueOf((String)request.getAttribute("Hab_CargosCicloRB")).booleanValue() ; %>
        	Si <html:radio  tabindex="1" property="rbCiclo" value="SI" name="CargosForm" disabled="<%=Hab_CargosCicloRB %>" />
        	No <html:radio  tabindex="2" property="rbCiclo" value="NO" name="CargosForm" disabled="<%=Hab_CargosCicloRB %>" />
        </div>        	
          </td>
        <td width="32">&nbsp;</td>
      ...
      <tr>
        ...
        <logic:iterate indexId="indice" id="i" name="CargosForm" property="tablaCargos">
  		...
  		<tr>
	        ...
	        <td class="textoDerechaCargosFilasTabla"><bean:write name="CargosForm" property="total"/></td>
