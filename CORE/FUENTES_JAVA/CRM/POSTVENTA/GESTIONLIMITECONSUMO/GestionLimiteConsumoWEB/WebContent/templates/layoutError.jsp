...
<%
	...
	String codOrdenServicio = (String)request.getSession().getAttribute("CodOrdenServicio");
	
	String cerrarAction = null;
	
	if("10668".equals(codOrdenServicio)){
		cerrarAction = "../abonoLimiteConsumo/CerrarAction.do?timestamp=" + time;
	}else if("10666".equals(codOrdenServicio)){
		cerrarAction = "../modificacionLimiteConsumo/CerrarAction.do?timestamp=" + time;
