...
public class FacturacionDTO implements Serializable{
	...
	private String numSecuenciaEncabezado;
	private String numSecuenciaDetalle;
	
	public String getNumSecuenciaDetalle() {
		return numSecuenciaDetalle;
	}
	public void setNumSecuenciaDetalle(String numSecuenciaDetalle) {
		this.numSecuenciaDetalle = numSecuenciaDetalle;
	}
	public ArrayList getListaFact() {
		return listaFact;
	}
	public void setListaFact(ArrayList listaFact) {
	...
	public String getEstadoListaFact() {
		return estadoListaFact;
	}
	public void setEstadoListaFact(String estadoListaFact) {
		this.estadoListaFact = estadoListaFact;
	}
	public String getNumSecuenciaEncabezado() {
		return numSecuenciaEncabezado;
	}
	public void setNumSecuenciaEncabezado(String numSecuenciaEncabezado) {
		this.numSecuenciaEncabezado = numSecuenciaEncabezado;
	}
