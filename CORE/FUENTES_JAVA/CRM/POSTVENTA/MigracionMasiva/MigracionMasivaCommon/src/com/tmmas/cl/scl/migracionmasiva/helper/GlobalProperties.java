...
package com.tmmas.cl.scl.migracionmasiva.helper;
 ...
 * Archivo interno: com/tmmas/cl/scl/cambioSerie/common/properties/CambioSerieWSInterno.properties
 * Archivo externo: <user.dir>/propiedades/CambioSerieWSExterno.properties
 *
 * @author  Everis
...
public class GlobalProperties {
	...
	private static String propertiesExterno = "/com/tmmas/cl/scl/properties/MigracionMasivaWS.properties";
	...
	private GlobalProperties() {
		...
		try {
			System.out.println("Antes de obtener propertie externo");
			System.out.println("Properties Externo: "+System.getProperty("user.dir") + propertiesExterno);
			propFile = new FileInputStream(System.getProperty("user.dir") + propertiesExterno);
			propertieExterno.load(propFile);
			System.out.println("Despues de obtener propertie externo");
		...
		System.out.println("Properties interno:  "+archivoRecurso );
	...
	public String getJndiDataSource() {
		String jndi=this.getValorExterno("jndi.dataSource");
		System.out.println("Jndi Datasource: "+jndi);
		return jndi;
	}
