...
public class PresupuestoAction extends Action{
	...
	private AvisoSiniestroBussinessDelegate delegateAvisoDeSiniestro = AvisoSiniestroBussinessDelegate.getInstance();
	...
	//				 //cierre venta
			    	...
			    	AvisoSiniestrodelegate.guardaMensajesError(request, "Error en el Módulo de Cargos o Prebilling", textoMensajeRestricciones);
