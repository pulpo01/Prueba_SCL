...
<table width="100%" border="0">
    ...
    <!-- 
			 ...
			 El nombre del cliente  y el codigo del cliente se coloca en negrita y se justifican a la izquierda
		-->	 	
		<td width="50%" align="left">
		  <table border="0" cellpadding="0" cellspacing="0"  width="100%">
		    <tr>
			      <td width=35% class="valorCampoInformativo"><b>Nombre del Cliente:</b></td> 
	   ...
	   <td width="45%">
	   	<table border="0" cellpadding="0" cellspacing="0"  width="100%">
         <tr>
            <td width=29% class="valorCampoInformativo"><b>Código del Cliente:</b></td>
