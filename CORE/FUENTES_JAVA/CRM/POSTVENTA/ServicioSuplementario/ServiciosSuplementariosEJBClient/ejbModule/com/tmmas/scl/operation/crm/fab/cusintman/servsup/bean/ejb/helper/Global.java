package com.tmmas.scl.operation.crm.fab.cusintman.servsup.bean.ejb.helper;
...
public class Global extends  com.tmmas.scl.operations.crm.fab.customerinterfacemanagement.common.helper.GlobalBase implements Serializable {
	...
	public static synchronized Global getInstance() {
			if (instance == null) {
				instance = new Global("com.tmmas.scl.operation.crm.fab.cusintman.servsup.bean.ejb.properties.negocio");
			}
			return instance;
		}
