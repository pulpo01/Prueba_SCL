...
<div id="comboCargaTributaria" style="display:<c:out value="${requestScope.condComCK}"/>;">
<table width="100%" border="0">
  ...
  <tr>
    <td width="33%" >
        <html:checkbox onclick ="asignaValorAControl();" name="CambioDeSimCardForm" property="condicionesCK"  />
