...
<%@ taglib uri="/WEB-INF/tld/c.tld" prefix="c" %>
	...
	<input type="hidden" id="contextpathCS" name="contextpathCS" value="<c:out value="${pageContext.request.contextPath}"/>"/>
...
<!--  					----------- SELECCION DE EQUIPO -----------		-->
					...
					<td width="450" rowspan="5">
						...
						<tr height="25">
							...
							<td> 
								<html:text style="text-align: right;" tabindex="7" property="nroSerie" size="30" maxlength="30" onkeypress="if (window.event.keyCode==13) window.event.keyCode=0;"/>
				        		<div id="divLnkSelSerie" style="display: inline;">
									<a href="javascript:fncBuscarSerie('<%=request.getContextPath()%>/BuscaSimcardAction.do?opcion=inicioSimcard');"><font color="#0000ff">Buscar Serie</font></a>
								</div>								
							</td>
						</tr>	
						...
						<tr height="25">
						    <td align="center" colspan=2>
								...
								onmouseover="sobreElBoton('bloquear','botones/btn_bloquear_roll.gif')" onMouseOut="sobreElBoton('bloquear','botones/btn_bloquear.gif')" onclick="bloquearSerie('bloquear');" />
								 <img src="botones/btn_desbloquear.gif" name="desbloquear" border="0" id="desbloquear" alt="cancelar"
...
<!--  					---------------------------------------------------  -->						
				...
				<tr>
					...
					<td>
						<html:select  tabindex="1" property="tipoContrato" size="1">
				...
				<tr>
					...
					<td>
						...
						<tr height="25">
							<td> 
							<html:select tabindex="3" property="modalidadPago" size="1"  onchange="cargaComboCuotas(this.value);"  disabled="true">
									<option value="">						
								</html:select>
							</td>
							<td>&nbsp;&nbsp;&nbsp;</td>
