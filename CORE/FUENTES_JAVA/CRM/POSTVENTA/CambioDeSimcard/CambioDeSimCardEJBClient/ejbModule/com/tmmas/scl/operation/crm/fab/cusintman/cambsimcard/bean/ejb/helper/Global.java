package com.tmmas.scl.operation.crm.fab.cusintman.cambsimcard.bean.ejb.helper;
...
public class Global extends  com.tmmas.scl.operations.crm.fab.customerinterfacemanagement.common.helper.GlobalBase implements Serializable {
	...
	public static synchronized Global getInstance() {
			if (instance == null) {
				instance = new Global("com.tmmas.scl.operation.crm.fab.cusintman.cambsimcard.bean.ejb.properties.negocio");
			}
			return instance;
		}
...
/*	
	...
	private final String archivoRecurso = "com.tmmas.scl.operation.crm.fab.cusintman.cambsimcard.bean.ejb.properties.negocio";
