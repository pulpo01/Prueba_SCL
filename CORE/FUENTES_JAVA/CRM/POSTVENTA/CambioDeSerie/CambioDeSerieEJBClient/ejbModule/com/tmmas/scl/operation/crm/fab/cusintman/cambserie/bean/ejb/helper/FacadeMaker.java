package com.tmmas.scl.operation.crm.fab.cusintman.cambserie.bean.ejb.helper;
...
public class FacadeMaker {
	...
	private ConsultaFacadeSTL socketPSFacade = null;
...
//	-------------------------------------------------------------------------------------------------------------------------------------------	
	...
	/**
	 * Obtiene la interfaz remota del SocketPS
	 * @return
...
//	 ConsultaFacade	
	public ConsultaFacadeSTL getSocketPSFacade() throws SocketPSException {
		
		try 
		{                    
			if(socketPSFacade ==null)
			{
				this.getEJBInstance (global.getValor("url.SocketPSEJBEARProvider"), global.getValor("jndi.ConsultaFacadeSTL"));		
				ConsultaFacadeSTLHome home =(ConsultaFacadeSTLHome) PortableRemoteObject.narrow(obj, ConsultaFacadeSTLHome.class);		
				socketPSFacade = home.create();
			}
		}
		catch (Exception e) 
		{
