...
<link href="<%=request.getContextPath()%>/cambioSerie/css/mas.css" rel="stylesheet" type="text/css" />
<script>	
      ...
      <table width="80%">
        <tr>
         <td class="textoSubTitulo" >
	       <h2><IMG src="<%=request.getContextPath()%>/img/green_arrow.gif" width="15" height="15" hspace="2" align="left">B&uacute;squeda Series&nbsp;
         </td>            
        </tr>
      </table>
	  <P>
...
<tr><td width="100%">
      ...
      <tr>
          ...
          <td align="left" width="50%">
			  <html:select name="BuscaSeriesForm" property="codCriterioBusqueda" style="width:300px;" onchange="ocultarMensajeError();fncMostrarFiltros();"> 
 ...
 <tr><td> 
    ...
    <table width="100%">    
     <tr>  
          ...
          <td align="left" width="50%">
			  <html:select name="BuscaSeriesForm" property="codBodega" style="width:300px;" onchange="ocultarMensajeError();fncBuscar();" > 
				<html:option value="">- Seleccione -</html:option>
 ...
 <tr><td> 
    ...
    <table width="100%"> 
     <tr>  
          ...
          <td align="left" width="50%">
			  <html:select name="BuscaSeriesForm" property="codArticulo" style="width:300px;" onchange="ocultarMensajeError();fncBuscar();" > 
				<html:option value="">- Seleccione -</html:option>
    ...
    <table width="100%">  
     ...
     <tr>  
          ...
          <td align="left" width="35%">
			<html:text name="BuscaSeriesForm" property="txtFiltro" size="35" maxlength="25" onkeypress="return onlyInteger(event);" onchange="ocultarMensajeError();" />          
          </td>             
          <td width="25%">&nbsp;</td>      
	 </tr>
	</table>
 ...
 <tr><td> 
	<table width="100%">    
     ...
     <tr align="center">
	     ...
	     <logic:notEmpty name="BuscaSeriesForm" property="serieAjaxDTOs">
	    <table width="100%"> 
	    <tr>
	 ...
	 <logic:empty name="BuscaSeriesForm" property="serieAjaxDTOs">
	 	<logic:notEmpty name="BuscaSeriesForm" property="mensaje">
	 		<center><p><bean:write name="BuscaSeriesForm" property="mensaje"/></p></center>
	 	</logic:notEmpty>  
	 </logic:empty>
	    </td>
	 </tr>  	 
