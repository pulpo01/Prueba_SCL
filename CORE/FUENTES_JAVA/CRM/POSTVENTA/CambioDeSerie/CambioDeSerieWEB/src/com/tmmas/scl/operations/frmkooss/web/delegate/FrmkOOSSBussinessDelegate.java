...
import com.tmmas.scl.framework.commonDoman.exception.FrmkCargosException; // RRG 10-07-2009 96723 COL
public class FrmkOOSSBussinessDelegate {
	...
	public ObtencionCargosDTO obtencionCargos(ParametrosObtencionCargosDTO parametrosCargos) throws GeneralException{	
		...
		log=System.getProperty("user.dir")+ log;
		PropertyConfigurator.configure(log);		
		logger.debug("FrmkOOSSBussinessDelegate:obtencionCargos():start");
		try { // INICIO RRG 10-07-2009 96723 COL
		...
		/*}catch(GeneralException e){
			...
			logger.debug("RemoteException[" + loge + "]");
			throw new GeneralException(e);
		} // INICIO RRG 10-07-2009 96723 COL
		logger.debug("FrmkOOSSBussinessDelegate:obtencionCargos():end");
		return resultado;
	}
