...
public class CatalogueDAO {
	  ...
	  private static Map allItems = new HashMap();
	  ...
	  public String ValidaDWR(String mensaje){
		  
		  CustomerOrderDelegate validador=CustomerOrderDelegate.getInstance();
		  return validador.ValidaSC(mensaje);
	  }
	  /**
	  ...
	  public List findItems(String expression) {
	    ...
	    for (Iterator I = allItems.values().iterator() ; I.hasNext() ; ) {
