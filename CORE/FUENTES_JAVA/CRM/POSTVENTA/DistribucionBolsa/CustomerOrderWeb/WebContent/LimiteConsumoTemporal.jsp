...
<div align="center"><html:errors bundle="errors" /> <html:form
	action="/LimiteConsumoTemporalAction">
				...
				<table border="0" cellspacing="1" cellpadding="2" width="100%">
					<tr>                  
					    <td width="50%" colspan="8" align="left" class="amarillo" >
					      <img src="img/green_arrow.gif" width="15" height="15" hspace="2" align="left" /><strong>Modificaci&oacute;n Temporal de Limite de Consumo por Abonado</strong>
					    </td>					
				...
				<table border="0" cellspacing="1" cellpadding="2" width="100%">
					...
					<logic:iterate indexId="count" id="servicio" name="limConTempList" scope="session" type="com.tmmas.cl.scl.pv.customerorder.commonapp.dto.LimiteConsumoTemporalDTO">
						...
						<tr class="<%=colorFila%>">
    			            ...
    			            <td align="center"><bean:write name="servicio" property="cod_plan" /></td> <!-- RRG -->
				            ...
				            <td align="right"><input type="text" name="valorAsignado" value="<%=servicio.getLimiteConsumido()%>" onblur="validaNum(this,<%=servicio.getLimiteConsumido()%>);"  class="normal"></td>
						</tr>
					</logic:iterate >		
				</table>
			</td>
