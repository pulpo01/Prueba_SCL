...
public class SolicitudAutDescuentoAction extends BaseAction {
	private final Logger logger = Logger.getLogger(SolicitudAutDescuentoAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if (solicitudAutDescuentoForm.getAccion().equalsIgnoreCase("ConsultarEstado")){
			...
			String numAutoriza=solicitudAutDescuentoForm.getNumAutorizacion();
			numAutoriza=numAutoriza==null||"".equals(numAutoriza)?"0":numAutoriza;
			registro.setNumeroAutorizacion(Long.parseLong(numAutoriza));
