...
import com.tmmas.scl.framework.productDomain.dataTransferObject.Carta10231DTO;
...
public class ResumenAction extends Action {
	...
	private AnulacionSiniestroBussinessDelegate delegateAnulacionSiniestro = AnulacionSiniestroBussinessDelegate.getInstance();
...
//		Se procede a realizar el cierre de la venta
		...
		Carta10231DTO carta= new Carta10231DTO();
    	carta.setCodOOSS("10231");
		...
		if(botonSeleccionado!=null&&botonSeleccionado.equals("visualizar")){
			...
			ouputStream.close();
				...
				delegateAnulacionSiniestro.guardaMensajesError(request, "Ha ocurrido un problema al intentar imprimir el reporte.", "Consulte por favor el log del sistema para averiguar la razón del inconveniente.");
