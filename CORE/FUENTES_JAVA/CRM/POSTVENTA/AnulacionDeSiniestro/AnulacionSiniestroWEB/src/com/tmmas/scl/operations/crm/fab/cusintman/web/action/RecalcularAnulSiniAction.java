...
public class RecalcularAnulSiniAction extends BaseAction{
	private Global global = Global.getInstance();
	private final Logger logger = Logger.getLogger(RecalcularAnulSiniAction.class);
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {	
		...
		sessionData.setCodActAboCargosUso(global.getValor("ACT_ANULACIONSINIESTRO"));
		...
		sessionData.setCargosObtenidos(null);//Limpieza de Cargos
			...
			"Si el problema persiste, favor comunicarse con el administrador de sistema.";//e.setMessage(textoMensajeRestricciones);
