...
import com.tmmas.scl.operations.crm.fab.cusintman.srv.anusin.helper.Global;
...
public class AnulacionSiniestroSrv implements AnulacionSiniestroSrvIF {

	private final Logger logger = Logger.getLogger(AnulacionSiniestroSrv.class);
...
//	 ---------------------------------------------------------------------------
	...
	public void anulaNumeroConstanciaPolicial(SiniestrosDTO siniestros) throws ProductException {
		...
		try {
			...
			siniestroBO.anulaNumeroConstanciaPolicial(siniestros);
	...
	public ParametrosGeneralesDTO getParametroGeneral(ParametrosGeneralesDTO parametrosGeneralesDTO) throws GeneralException	{
		...
		try {
			...
			retValue = datosGeneralesBO.getParametroGeneral(parametrosGeneralesDTO);
