...
public class ConsParametrosDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements ConsParametrosDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(ConsParametrosDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public ConsParametrosDTODAOImpl() {
	...
	*/
	public com.tmmas.gte.integraciongtecommon.dto.ConsParametrosResponseDTO consultarParametros(com.tmmas.gte.integraciongtecommon.dto.ConsParametrosDTO inParam0)
			 throws com.tmmas.gte.integraciongtecommon.exception.IntegracionGTEException{
		logger.info("consultarParametros:start()");
		java.sql.Connection conn = null;
		java.sql.CallableStatement cstmt = null;
		logger.info("declara parametro de salida...");
		com.tmmas.gte.integraciongtecommon.dto.ConsParametrosResponseDTO outParam0 = new com.tmmas.gte.integraciongtecommon.dto.ConsParametrosResponseDTO();
