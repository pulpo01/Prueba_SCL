...
public class AltaPrepagoResponseDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements AltaPrepagoResponseDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(AltaPrepagoResponseDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public AltaPrepagoResponseDTODAOImpl() {
