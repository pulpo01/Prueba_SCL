...
public class IdentificacionDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements IdentificacionDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(IdentificacionDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public IdentificacionDTODAOImpl() {
	...
	* 
	*/
	public com.tmmas.gte.integraciongtecommon.dto.IdentificacionResponseDTO consultarTipoIdent(com.tmmas.gte.integraciongtecommon.dto.IdentificacionDTO inParam0)
			 throws com.tmmas.gte.integraciongtecommon.exception.IntegracionGTEException{
		logger.info("consultarTipoIdent:start()");
		java.sql.Connection conn = null;
		java.sql.CallableStatement cstmt = null;
		logger.info("declara parametro de salida...");
		com.tmmas.gte.integraciongtecommon.dto.IdentificacionResponseDTO outParam0 = new com.tmmas.gte.integraciongtecommon.dto.IdentificacionResponseDTO();
		...
		try {
			String call = "{call GE_INTEGRACION_PG.GE_CONS_TIPOS_IDENT_PR(?,?,?,?,?)}";
			logger.info("call[" + call + "]");

			cstmt = conn.prepareCall(call);

			logger.info("armar parametros de entrada...");
			cstmt.setString(1,inParam0.getCodTipIdent());
			...
			outParam0.setDesIdentificacion(cstmt.getString(2));
			logger.debug("desIdentificacion[" + outParam0.getDesIdentificacion() + "]");
		...
		logger.info("consultarTipoIdent:end()");
		return outParam0;
	}
