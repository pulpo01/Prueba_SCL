...
public class NumeracionDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements NumeracionDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(NumeracionDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public NumeracionDTODAOImpl() {
	...
	* 
	*/
	public com.tmmas.gte.integraciongtecommon.dto.RespBooleanDTO consultarNumeracion(com.tmmas.gte.integraciongtecommon.dto.ParamOperNumTelefDTO inParam0)
		...
		try {
			String call = "{call GE_INTEGRACION_PG.GE_VALNUMTELEFONICA_PR(?,?,?,?,?)}";
			...
			cstmt.setString(2,inParam0.getCodOperadora());
			logger.debug("codOperadora[" + inParam0.getCodOperadora() + "]");
