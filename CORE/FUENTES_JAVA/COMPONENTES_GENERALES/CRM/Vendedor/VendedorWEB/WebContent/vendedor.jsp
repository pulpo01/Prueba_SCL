...
<table width="100%">
 <tr>
	<!-- Operadora -->
    <td class="barraarriba">Usuario: <c:out value="JLOPEZ"/>  &nbsp;Operadora: Movistar Colombia
  </td>
 </tr>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="30%">
    	<html:text property="codVendedor" tabindex="1"/>
    	&nbsp;&nbsp;
...
<c:if test="${(empty vendedor) or (empty vendedor.nom_vendealer)}">  
 ...
 <c:if test="${(empty vendedor) or (empty vendedor.des_provincia)}">   
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>
		<a href="#"><img style="cursor: pointer;" src="botones/btn_salir.gif" name="buscar" border="0" id="buscar"  alt="buscar" 
