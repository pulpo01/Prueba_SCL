...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="70%"><input  tabindex="2" type="text" id="totalConceptos"  name="totalConceptos" value='<c:out value="${totalesPresupuesto[0]}"/>' disabled="disabled"/></td>
    <td width="3%">&nbsp;</td>
  </tr>
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="17%" class="campoInformativo"> Total Impuestos</td>
    <td width="70%"><input  tabindex="3" type="text" id="totalImpuestos"  name="totalImpuestos" value='<c:out value="${totalesPresupuesto[1]}"/>' disabled="disabled"/></td>
    <td width="3%">&nbsp;</td>
  </tr>
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="17%" class="campoInformativo"> Total Descuentos</td>
    <td width="70%"><input  tabindex="4" type="text" id="totalDescuentos"  name="totalDescuentos" value='<c:out value="${totalesPresupuesto[2]}"/>' disabled="disabled"/></td>
    <td width="3%">&nbsp;</td>
  </tr>
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="17%" class="campoInformativo"> Total Presupuesto</td>
    <td width="70%"><input  tabindex="5" type="text" id="totalPresupuesto" name="totalPresupuesto" value='<c:out value="${totalesPresupuesto[3]}"/>' disabled="disabled"/></td>
    <td width="3%">&nbsp;</td>
  </tr>
