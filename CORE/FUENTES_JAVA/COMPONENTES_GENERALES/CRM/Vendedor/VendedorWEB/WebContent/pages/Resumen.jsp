...
<table width="100%" border="0">
  ...
  <tr>
    <td width="23%"><div align="center"><img onclick='javascript:alert("No existe carta asociada a esta OOSS.");' src="botones/btn_imprimircarta.gif" alt="Imprimir Carta"  border=0 name="imprimircarta" width="143" height="19"  id="imprimircarta" 
	onmouseover="sobreElBoton('imprimircarta','botones/btn_imprimircarta_roll.gif')" onmouseout="sobreElBoton('imprimircarta','botones/btn_imprimircarta.gif')"/></div></td>
	<td width="37%">&nbsp;</td>
	<td width="40%">&nbsp;</td>	
  </tr>  
  <tr>
