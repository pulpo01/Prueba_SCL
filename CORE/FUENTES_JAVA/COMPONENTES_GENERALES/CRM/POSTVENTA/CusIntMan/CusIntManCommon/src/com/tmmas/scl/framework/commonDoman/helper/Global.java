...
public class Global extends  com.tmmas.scl.operations.crm.fab.customerinterfacemanagement.common.helper.GlobalBase implements Serializable {
	...
	public static synchronized Global getInstance() {
			if (instance == null) {
				instance = new Global("com.tmmas.scl.framework.commonDoman.properties.common");
			}
			return instance;
		}
/*
	...
	private static Global instance;
	private final String archivoRecurso = "com.tmmas.scl.framework.commonDoman.properties.common";
