...
public class EspecificacionServicioPromAtlantidaBOFactory implements EspecificacionServicioPromAtlantidaBOFactoryIT
{

	public EspecificacionServicioPromAtlantidaIT getBusinessObject() 
	{		
		return new EspecificacionServicioPromAtlantida();
	}
