...
public class PerfilProvisionamientoBOFactory implements PerfilProvisionamientoBOFactoryIT{

	public PerfilProvisionamientoIT getBusinessObject1() {		
		return new PerfilProvisionamiento();
	}
}
