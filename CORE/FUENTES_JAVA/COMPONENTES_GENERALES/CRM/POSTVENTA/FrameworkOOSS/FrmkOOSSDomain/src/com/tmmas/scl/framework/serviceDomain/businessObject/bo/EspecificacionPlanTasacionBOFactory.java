...
public class EspecificacionPlanTasacionBOFactory implements EspecificacionPlanTasacionBOFactoryIT
{

	public EspecificacionPlanTasacionIT getBusinessObject1() {		
		return new EspecificacionPlanTasacion();
	}
