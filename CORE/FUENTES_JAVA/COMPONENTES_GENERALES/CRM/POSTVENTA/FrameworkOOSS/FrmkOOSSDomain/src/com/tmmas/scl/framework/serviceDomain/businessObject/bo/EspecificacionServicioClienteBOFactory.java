...
public class EspecificacionServicioClienteBOFactory implements EspecificacionServicioClienteBOFactoryIT
{

	public EspecificacionServicioClienteIT getBusinessObject() 
	{		
		return new EspecificacionServicioCliente();
	}
