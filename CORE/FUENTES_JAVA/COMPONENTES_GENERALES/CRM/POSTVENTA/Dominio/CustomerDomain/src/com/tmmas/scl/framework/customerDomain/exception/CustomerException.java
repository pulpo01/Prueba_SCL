 ...
 *
 * Fecha ------------------- Autor  ------------------------- Cambios ----------
 * 26/09/2007     			 Cristian Toledo              		Versión Inicial
 */
...
public class CustomerException extends GeneralException {
	...
	public CustomerException(String codigo, long codigoEvento,
			String descripcionEvento) {
		super(codigo, codigoEvento, descripcionEvento);
		// TODO Auto-generated constructor stub
	}

	public CustomerException(String message, String codigo, long codigoEvento,
			String descripcionEvento) {
		super(message, codigo, codigoEvento, descripcionEvento);
		// TODO Auto-generated constructor stub
	}

	public CustomerException(String message, Throwable cause, String codigo,
