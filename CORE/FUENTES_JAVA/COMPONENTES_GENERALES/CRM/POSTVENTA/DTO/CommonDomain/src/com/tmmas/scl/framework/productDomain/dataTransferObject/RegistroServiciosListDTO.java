...
public class RegistroServiciosListDTO implements Serializable {
	private static final long serialVersionUID = 1L;

	private RegistroServiciosDTO[] servicios;
	private String claseServicios;
	

	public RegistroServiciosDTO[] getServicios() {
		return servicios;
	}

	public void setServicios(RegistroServiciosDTO[] servicios) {
