...
public abstract class GlobalBase {
	...
	private String archivoPropertiesDefault="/com/tmmas/scl/general/CPUdefault.properties";//scl/default.properties
	...
	private static String regex1="jndi.*acade|url\\..*|security.principal|security.credentials";
	private static String regex = regex1+"|jndi.*acadeSTL"+"|jndi.*ORC"+"|jndi.activacionmasiva.*";
