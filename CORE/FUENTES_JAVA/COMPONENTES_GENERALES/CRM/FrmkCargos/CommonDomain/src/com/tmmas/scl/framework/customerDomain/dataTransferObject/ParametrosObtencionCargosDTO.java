...
public class ParametrosObtencionCargosDTO implements Serializable{
	...
	// INI CSR11003
	private int numeroMesesProrroga;
	private int promoCelular;
   ...
   //	 ini-Proyecto p-mix-09003 OCB; 
	...
	//INI CSR11003
	public int getNumeroMesesProrroga() {
		return numeroMesesProrroga;
	}

	public void setNumeroMesesProrroga(int numeroMesesProrroga) {
		this.numeroMesesProrroga = numeroMesesProrroga;
	}
	
	public int getPromoCelular() {
		return promoCelular;
	}

	public void setPromoCelular(int promoCelular) {
