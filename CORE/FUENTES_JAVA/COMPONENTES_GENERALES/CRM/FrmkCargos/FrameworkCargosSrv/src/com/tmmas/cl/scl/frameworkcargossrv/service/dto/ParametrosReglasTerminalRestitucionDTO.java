...
public class ParametrosReglasTerminalRestitucionDTO extends ParametrosReglaDTO {
	...
	private String indicadorPrecioDeducible;
	private String indicadorRecambio;
	private String codigoAntiguedad;
	private String numMesesProrroga;
	private String promoCelular;
	...
	// FIN P-MIX-09003 OCB;
	public String getIndicadorPrecioDeducible() {
		return indicadorPrecioDeducible;
	}
	public void setIndicadorPrecioDeducible(String indicadorPrecioDeducible) {
		this.indicadorPrecioDeducible = indicadorPrecioDeducible;
	}
	public String getIndicadorRecambio() {
		return indicadorRecambio;
	}
	public void setIndicadorRecambio(String indicadorRecambio) {
		this.indicadorRecambio = indicadorRecambio;
	}
	...
	public String getNumMesesProrroga() {
		return numMesesProrroga;
	}
	public void setNumMesesProrroga(String numMesesProrroga) {
		this.numMesesProrroga = numMesesProrroga;
	}
	public String getPromoCelular() {
		return promoCelular;
	}
	public void setPromoCelular(String promoCelular) {
