...
public class ReglasServiciosSuplementariosPV extends ReglaListaPrecio{

	private final Logger logger = Logger.getLogger(ReglasServiciosSuplementariosPV.class);
	...
	public ReglasServiciosSuplementariosPV(ParametrosReglasServicioSuplementarioDTO parametros) {
		super(parametros);
	...
	public PrecioDTO[] seleccionPrecios() {
		...
		try {
			...
			e.printStackTrace();
			arregloPrecios=new PrecioDTO[0];
		}
