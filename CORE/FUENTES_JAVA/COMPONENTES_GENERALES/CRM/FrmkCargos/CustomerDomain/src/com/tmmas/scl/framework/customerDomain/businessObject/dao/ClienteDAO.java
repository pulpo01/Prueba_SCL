...
public class ClienteDAO extends ConnectionDAO implements ClienteDAOIT {
	...
	public ClienteDTO getCliente(ClienteDTO cliente) throws CustomerException{
		...
		CallableStatement cstmt = null;
		try {
			String call = getSQLDatosCliente("PV_SERVICIOS_POSVENTA_PG","VE_consulta_cliente_PR",25);
			...
			/**
			 * @author rlozano
			 * @description se realiza validacion fecha nacimiento
			 * @param Date
			 * @return Date
			 */
			Date fecNac=cstmt.getDate(8);
			
			cliente.setFechaNacimiento(fecNac==null?null:new Timestamp (fecNac.getTime()));
