...
public class RegistroFacturacionDAO extends ConnectionDAO implements RegistroFacturacionDAOIT{
	...
	public RegistroFacturacionDTO getCodigoPromedioFacturado(RegistroFacturacionDTO entrada) throws ProductException{
		...
		try {
			...
			String call = getSQLPackage("PV_SERVICIOS_POSVENTA_PG","VE_obtiene_codpromedio_fact_PR",5);
	...
	public RegistroFacturacionDTO getCodigoCicloFacturacion(ClienteDTO cliente) throws ProductException{
		...
		try {
			...
			conn = getConnectionFromWLSInitialContext(global.getCPUJndiForDataSource());
			String call = getSQLPackage("PV_SERVICIOS_POSVENTA_PG","VE_consulta_ciclo_fact_PR",5);

			logger.debug("sql[" + call + "]");

			cstmt = conn.prepareCall(call);
			logger.debug("Set cliente.getCodCiclo()       [" + cliente.getCodCiclo()+"]");
			logger.debug("cliente.getCodigoCiclo()        [" + cliente.getCodigoCiclo()+"]");
			logger.debug("cliente.getCodCicloFacturacion()[" + cliente.getCodCicloFacturacion()+"]");
	...
	public RegistroFacturacionDTO getModoGeneracion(RegistroFacturacionDTO registroFacturacion) throws ProductException{
		...
		try {
			...
			conn = getConnectionFromWLSInitialContext(global.getCPUJndiForDataSource());
			String call = getSQLPackage("PV_SERVICIOS_POSVENTA_PG","VE_obtiene_modo_gener_fact_PR",13);

			logger.debug("sql[" + call + "]");

			cstmt = conn.prepareCall(call);
			cstmt.setString(1,registroFacturacion.getCodigoOficina());
			logger.debug("getCodigoOficina           [" +  registroFacturacion.getCodigoOficina()+"]");
			cstmt.setString(2,registroFacturacion.getCodigoTipoDocumento());
			logger.debug("getCodigoTipoDocumento     [" + registroFacturacion.getCodigoTipoDocumento()+"]");
			cstmt.setString(3,registroFacturacion.getValorParametroFacturaGlobal());
			logger.debug("getValorParamFacturaGlobal [" + registroFacturacion.getValorParametroFacturaGlobal()+"]");
			cstmt.setString(4,registroFacturacion.getValorParametroDocumentoGuia());
			logger.debug("getValorParamDocumentoGuia [" + registroFacturacion.getValorParametroDocumentoGuia()+"]");
			cstmt.setString(5,registroFacturacion.getCodigoTipoFoliacion());
			logger.debug("getCodigoTipoFoliacion     [" + registroFacturacion.getCodigoTipoFoliacion()+"]");
			cstmt.setString(6,registroFacturacion.getCodigoTipoMovimiento());
			logger.debug("getCodigoTipoMovimiento    [" + registroFacturacion.getCodigoTipoMovimiento()+"]");
			cstmt.setString(7,registroFacturacion.getCategoriaTributaria());
			logger.debug("getCategoriaTributaria     [" + registroFacturacion.getCategoriaTributaria()+"]");
			cstmt.setString(8,registroFacturacion.getValorParametroFlagCentroFact());
			logger.debug("getValorParamFlagCentroFact[" + registroFacturacion.getValorParametroFlagCentroFact()+"]");
			cstmt.setString(9,registroFacturacion.getModalidadVenta());
			logger.debug("getModalidadVenta          [" + registroFacturacion.getModalidadVenta()+"]");
	...
	public ProcesoDTO actualizaFacturacion(RegistroFacturacionDTO parametroEntrada) throws ProductException{
		...
		try {
			...
			String call = getSQLPackage("PV_SERVICIOS_POSVENTA_PG","VE_ACTUALIZA_FACTURACION_PR",13);

			logger.debug("sql[" + call + "]");
			conn = getConnectionFromWLSInitialContext(global.getCPUJndiForDataSource());
			cstmt = conn.prepareCall(call);
			cstmt.setString(1,parametroEntrada.getEstadoDocumento());
			logger.debug("estadoDocumento         [" + parametroEntrada.getEstadoDocumento() + "]");
			cstmt.setString(2,parametroEntrada.getEstadoProceso());
			logger.debug("estadoProceso           [" + parametroEntrada.getEstadoProceso() + "]");
			cstmt.setString(3,parametroEntrada.getCategoriaTributaria());
			logger.debug("categoriaTributaria     [" + parametroEntrada.getCategoriaTributaria() + "]");
			cstmt.setString(4,parametroEntrada.getNumeroFolio());
			logger.debug("numeroFolio             [" + parametroEntrada.getNumeroFolio() + "]");
			cstmt.setString(5,parametroEntrada.getPrefijoPlaza());
			logger.debug("prefijoPlaza            [" + parametroEntrada.getPrefijoPlaza() + "]");
			cstmt.setString(6,parametroEntrada.getFechaVencimiento());
			logger.debug("fechaVencimiento        [" + parametroEntrada.getFechaVencimiento() + "]");
			cstmt.setString(7,parametroEntrada.getNombreUsuarioEliminacion());
			logger.debug("nombreUsuarioEliminacion[" + parametroEntrada.getNombreUsuarioEliminacion() + "]");
			cstmt.setString(8,parametroEntrada.getCausalEliminacion());
			logger.debug("causalEliminacion       [" + parametroEntrada.getCausalEliminacion() + "]");
			cstmt.setString(9,parametroEntrada.getNumeroProcesoFacturacion());
			logger.debug("numeroProcesoFacturacion[" + parametroEntrada.getNumeroProcesoFacturacion() + "]");
			cstmt.setString(10,parametroEntrada.getNumeroVenta());
			logger.debug("numeroVenta             [" + parametroEntrada.getNumeroVenta() + "]");
			cstmt.registerOutParameter(11, java.sql.Types.NUMERIC);
			cstmt.registerOutParameter(12, java.sql.Types.VARCHAR);
			cstmt.registerOutParameter(13, java.sql.Types.NUMERIC);
