...
public class TerminalBO implements TerminalBOIT{
		...
		throws ProductException{
			...
			resultado = terminalDAO.getPrecioCargoTerminal_PrecioLista_Rest(entrada);
		...
		throws ProductException{
			...
			resultado = terminalDAO.getPrecioCargoTerminal_NoPrecioLista_Rest(entrada);
		...
		throws ProductException{
			...
			resultado = terminalDAO.getPrecioCargoTerminal_NoPrecioLista_Rest_PV(entrada);
		...
		throws ProductException{
			...
			resultado = terminalDAO.getPrecioCargoTerminal_Deducible_Rest(entrada);
