	...
	function fncAceptar() {
		...
		if (codRegion!=null){
			...
			if (esObligatorio.value=="true" && codRegion.value==""){
				...
				if (document.getElementById("control_COD_REGION").selectedIndex >0)					
		    		arrayCodigos.push({codigo:document.getElementById("COD_REGION").value,descripcion:document.getElementById("descripcionCOD_REGION").value, atributo:"COD_REGION"});
			}
		}
		...
		if (codProvincia!=null){
			...
			if (esObligatorio.value=="true" && codProvincia.value==""){
				...
				if (document.getElementById("control_COD_PROVINCIA").selectedIndex >0)				
					arrayCodigos.push({codigo:document.getElementById("COD_PROVINCIA").value,descripcion:document.getElementById("descripcionCOD_PROVINCIA").value, atributo:"COD_PROVINCIA"});
		...
		if (codCiudad!=null){
			...
			if (esObligatorio.value=="true" && codCiudad.value==""){
				...
				if (document.getElementById("control_COD_CIUDAD").selectedIndex >0)
		        	arrayCodigos.push({codigo:document.getElementById("COD_CIUDAD").value,descripcion:document.getElementById("descripcionCOD_CIUDAD").value, atributo:"COD_CIUDAD"});
			}
		}
		...
		if (codComuna!=null){
			...
			if (esObligatorio.value=="true" && codComuna.value==""){
				...
				if (document.getElementById("control_COD_COMUNA").selectedIndex >0)
		        	arrayCodigos.push({codigo:document.getElementById("COD_COMUNA").value,descripcion:document.getElementById("descripcionCOD_COMUNA").value, atributo:"COD_COMUNA"});
			}
		}
		...
		if (codTipoCalle!=null){
			...
			if (esObligatorio.value=="true" && codTipoCalle.value==""){
				...
				if (document.getElementById("control_COD_TIPOCALLE").selectedIndex >0)	
					arrayCodigos.push({codigo:document.getElementById("COD_TIPOCALLE").value,descripcion:document.getElementById("descripcionCOD_TIPOCALLE").value, atributo:"COD_TIPOCALLE"});
			}
		}
		...
		if (nomCalle!=null){
			...
			if (esObligatorio.value=="true" && nomCalle.value==""){
				...
				arrayCodigos.push({codigo:document.getElementById("NOM_CALLE").value,descripcion:document.getElementById("NOM_CALLE").value, atributo:"NOM_CALLE"});				
			}
		}
		...
		if (numCalle!=null){
			...
			if (esObligatorio.value=="true" && numCalle.value==""){
				...
				document.getElementById("NUM_CALLE").value = numCalle.value;	
				 arrayCodigos.push({codigo:document.getElementById("NUM_CALLE").value,descripcion:document.getElementById("NUM_CALLE").value, atributo:"NUM_CALLE"});
			}
		}
		...
		if (obsDireccion!=null){
			...
			if (esObligatorio.value=="true" && obsDireccion.value==""){
				...
				arrayCodigos.push({codigo:document.getElementById("OBS_DIRECCION").value,descripcion:document.getElementById("OBS_DIRECCION").value, atributo:"OBS_DIRECCION"});
			}
		}
		...
		if (zip!=null){
			...
			if (esObligatorio.value=="true" && zip.value==""){
				...
				arrayCodigos.push({codigo:document.getElementById("ZIP").value,descripcion:document.getElementById("descripcionZIP").value, atributo:"ZIP"});
			}
		}
		...
		if (desDirec1!=null){
			...
			if (esObligatorio.value=="true" && desDirec1.value==""){
			    ...
			    arrayCodigos.push({codigo:document.getElementById("DES_DIREC1").value,descripcion:document.getElementById("DES_DIREC1").value, atributo:"DES_DIREC1"});
			}
		}
		...
		if (desDirec2!=null){
			...
			if (esObligatorio.value=="true" && desDirec1.value==""){
			    ...
			    arrayCodigos.push({codigo:document.getElementById("DES_DIREC2").value,descripcion:document.getElementById("DES_DIREC2").value, atributo:"DES_DIREC2"});
			}
		}						
					
		window.returnValue = arrayCodigos;
		window.close();
	}
 	//(-)-- ACEPTAR --
...
<html:hidden property="COD_REGION"/>
<html:hidden property="COD_PROVINCIA"/>
<html:hidden property="COD_CIUDAD"/>
<html:hidden property="COD_COMUNA"/>
<html:hidden property="COD_TIPOCALLE"/>
<html:hidden property="NOM_CALLE"/>
<html:hidden property="NUM_CALLE"/>
<html:hidden property="OBS_DIRECCION"/>
<html:hidden property="ZIP"/>
<html:hidden property="DES_DIREC1"/>
<html:hidden property="DES_DIREC2"/>
<html:hidden property="descripcionCOD_REGION"/>
<html:hidden property="descripcionCOD_PROVINCIA"/>
<html:hidden property="descripcionCOD_CIUDAD"/>
<html:hidden property="descripcionCOD_COMUNA"/>
<html:hidden property="descripcionCOD_TIPOCALLE"/>
<html:hidden property="descripcionZIP"/>
<html:hidden property="moduloOrigen"/>
<html:hidden property="codModuloSolicitudVenta"/>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0 align=center>
      <tr>
        ...
        <td align="left" width="25%" >
        <html:button  value="LIMPIAR" style="width:120px;color:black" property="btnLimpiar" onclick="ocultarMensajeError();fncLimpiar()"/>			
        </td>
