...
public class TransaccionDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements TransaccionDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(TransaccionDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public TransaccionDTODAOImpl() {
	...
	*/
	public com.tmmas.gte.pagoonlinecommon.dto.TransaccionDTO obtenerTransaccion()
		...
		com.tmmas.gte.pagoonlinecommon.dto.TransaccionDTO outParam0 = new com.tmmas.gte.pagoonlinecommon.dto.TransaccionDTO();
		...
		try {
			String call = "{call CO_PAGOSONLINE_PG.CO_OBTIENETRANSACCION_PR(?,?,?,?)}";
			...
			outParam1.setCodigoError(cstmt.getInt(2));
			logger.debug("codigoError[" + outParam1.getCodigoError() + "]");

			outParam1.setMensajeError(cstmt.getString(3));
			logger.debug("mensajeError[" + outParam1.getMensajeError() + "]");

			outParam1.setNumeroEvento(cstmt.getString(4));
			...
			outParam0.setNumTransaccion(cstmt.getInt(1));
			logger.debug("numTransaccion[" + outParam0.getNumTransaccion() + "]");
