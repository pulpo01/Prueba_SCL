...
public class EmpresaRecaudacionDTODAOImpl extends com.tmmas.cl.framework.base.ConnectionDAO implements EmpresaRecaudacionDTODAO{
	private CompositeConfiguration config;
	private static Logger logger = Logger.getLogger(EmpresaRecaudacionDTODAOImpl.class);
	private Global global = Global.getInstance();
	private ServiceLocator  serviceLocator = ServiceLocator.getInstance();

	public EmpresaRecaudacionDTODAOImpl() {
	...
	*/
	public com.tmmas.gte.pagoonlinecommon.dto.EmpresaRecaudacionDTO obtenerCaja(com.tmmas.gte.pagoonlinecommon.dto.EmpresaRecaudacionDTO inParam0)
		...
		com.tmmas.gte.pagoonlinecommon.dto.EmpresaRecaudacionDTO outParam0 = new com.tmmas.gte.pagoonlinecommon.dto.EmpresaRecaudacionDTO();
		...
		try {
			String call = "{call CO_PAGOSONLINE_PG.CO_OBTIENECAJA_PR(?,?,?,?,?)}";
			logger.info("call[" + call + "]");

			cstmt = conn.prepareCall(call);

			logger.info("armar parametros de entrada...");
			cstmt.setString(1,inParam0.getEmpRecaudadora());
			logger.debug("empRecaudadora[" + inParam0.getEmpRecaudadora() + "]");
			...
			outParam0.setCodCaja(cstmt.getInt(2));
			logger.debug("codCaja[" + outParam0.getCodCaja() + "]");
