CREATE OR REPLACE PROCEDURE            P_NP_INSERT_ESTADO_TRASPASO(
...
vp_num_traspaso         in ge_cargos.num_venta%TYPE,
vp_err                  OUT NUMBER
)
as
...
BEGIN
  ...
  VALUES (vp_cod_pedido,
    ...
    null);
  UPDATE npt_pedido
     SET num_doc_pedido =  vp_num_traspaso
