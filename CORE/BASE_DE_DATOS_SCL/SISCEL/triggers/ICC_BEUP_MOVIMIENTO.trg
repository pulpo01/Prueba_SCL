...
-- Modificacisn : 29-11-2004
-- Modificacisn : Se aplica proceso motor de interfaz comercial, y se migra, como primera actuacisn, la actuacisn 'VA'
-- Modificacisn : a la nueva configuracisn, por lo que es extraida del proceso P_GA_RESPUESTA
-- Responsable  : Fabian Aedo R.
