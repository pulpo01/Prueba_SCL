CREATE OR REPLACE TRIGGER SISCEL.al_beup_minmax
BEFORE UPDATE
...
begin
--
-- Asignacion de los valores de la fila actualizada a la variable v_minmax
--
...
-- la fila actualizada tenga equivalencia en stock y la cantidad minima
-- definida
