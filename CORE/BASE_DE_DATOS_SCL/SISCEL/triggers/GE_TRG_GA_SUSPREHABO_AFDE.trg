CREATE OR REPLACE TRIGGER GE_TRG_GA_SUSPREHABO_AFDE
AFTER DELETE ON GA_SUSPREHABO
...
BEGIN
  BEGIN
    ...
    v_modificacionUser.nom_tabla	    := 'GA_SUSPREHABO';
    v_modificacionUser.nom_columna	    := 'NUM_ABONADO';
    ...
    v_modificacionUser.val_antes	    := :OLD.NUM_ABONADO;
