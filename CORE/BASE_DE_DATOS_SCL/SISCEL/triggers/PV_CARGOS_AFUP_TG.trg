CREATE OR REPLACE TRIGGER PV_CARGOS_AFUP_TG
AFTER UPDATE ON GE_CARGOS
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
DECLARE
/*
<Documentación TipoDoc = "Trigger">
<Elemento Nombre = "PV_CARGOS_AFUP_TG Lenguaje="PL/SQL" Fecha="25-05-2005" Versión="1.0" Programador="Yuri Alvarez Ambiente="BD">
<Retorno>NA</Retorno>
...
WHEN NO_ERROR THEN
	 NULL;
WHEN OTHERS THEN
	 RAISE_APPLICATION_ERROR(-20099,'ERROR INESPERADO EN TRIGGER PV_CARGOS_AFUP_TG: ORA-'||TO_CHAR(SQLCODE),FALSE);
END;
/
SHOW ERRORS
