CREATE OR REPLACE FORCE VIEW al_vcertificado_ingresodev_vw (    num_orden,
                                                             cod_proveedor,
                                                             nom_proveedor,
                                                             num_orden_ref,
                                                             fec_creacion,
...
AS             
     ...
     FROM al_cabecera_ordenes2 al_cabecera_ordenes2,
          ...
          al_cabecera_ordenes3 al_cabecera_ordenes3,
    ...
    WHERE al_cabecera_ordenes2.tip_orden = 2
      ...
      AND al_cabecera_ordenes2.num_orden_ref = al_cabecera_ordenes3.num_orden(+)
      AND al_cabecera_ordenes3.tip_orden = 3
      ...
      AND al_lineas_ordenes2.cod_articulo = al_articulos.cod_articulo(+)
         UNION
   SELECT al_hcabecera_ordenes2.num_orden,
          al_hcabecera_ordenes2.cod_proveedor, al_proveedores.nom_proveedor,
          al_hcabecera_ordenes2.num_orden_ref,
          TO_CHAR (al_hcabecera_ordenes3.fec_creacion, 'DD-MM-YYYY'),
          TO_CHAR (al_hcabecera_ordenes3.fec_historico,
     ...
     FROM al_hcabecera_ordenes2 al_hcabecera_ordenes2,
          al_proveedores al_proveedores,
          al_hcabecera_ordenes3 al_hcabecera_ordenes3,
    ...
    WHERE al_hcabecera_ordenes2.tip_orden = 2
      ...
      AND al_hcabecera_ordenes2.num_orden_ref = al_hcabecera_ordenes3.num_orden(+)
      AND al_hcabecera_ordenes3.tip_orden = 3
