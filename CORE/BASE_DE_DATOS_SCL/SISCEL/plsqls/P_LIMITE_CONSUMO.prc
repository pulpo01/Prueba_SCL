CREATE OR REPLACE PROCEDURE P_LIMITE_CONSUMO(
...
--
-- *************************************************************
-- * procedimiento      : P_LIMITE_CONSUMO
...
-- *************************************************************
--
-- P_LIMITE_CONSUMO v1.1 RA-200512160334: German Espinoza Z; 18/12/2005
--
		 ...
		 IF YA_EXISTE = 'N' THEN -- PROYECTO LIMITE CONSUMO 05/11/2003
	         ...
	         INSERT INTO GA_INTARCEL
	             ...
	             VALUES (V_CLIENTE,V_ABONADO,V_NUMERO,
	                     VP_FECSYS,V_FECHASUP,V_LIMCONS,
	                     V_FRIENDS,V_DIASESP,V_CELDA,
	                     V_TIPPLANTARIF,V_PLANTARIF,V_SERIE,
	                     V_CELULAR,V_CARGOBASICO,V_CICLO,
	                     V_PLANCOM,V_PLANSERV,V_GRPSERV,
