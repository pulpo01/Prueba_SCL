CREATE OR REPLACE PACKAGE GE_CONSULTADIRECCION_PG IS
/*
<NOMBRE>  		  		  :GE_CONSULTADIRECCION_PG</NOMBRE>
...
TYPE COMUNAS IS REF CURSOR RETURN COMUNAS_REC;
 ...
 GV_cod_modulo    		  CONSTANT VARCHAR2 (2) := 'GE';
 GV_cod_modulo_ga    	  CONSTANT VARCHAR2 (2) := 'GA';
 GV_cod_producto    	  CONSTANT NUMBER   (1) := 1;
 GV_nom_parametro    	  CONSTANT VARCHAR2 (13):= 'TIP_DIRECCION';
