CREATE OR REPLACE PROCEDURE          "PV_REORDENAMITOINTAR_BK031103" 
...
BEGIN
   ...
   IF VP_PRODUCTO = 1 THEN
	  ...
	  -- FIN.MAM 27/05/2003
          ...
          BEGIN
                 SELECT  TIP_PLANTARIF, COD_PLANTARIF, COD_CARGOBASICO,
             COD_LIMCONSUMO, COD_CICLO, COD_HOLDING, COD_EMPRESA,COD_USO
                 INTO  V_TIPPLANTARIF, V_PLANTARIF, V_CARGOBASICO,
          ...
          EXCEPTION WHEN NO_DATA_FOUND THEN
                    ...
                    BEGIN
                       VP_TABLA := 'GA_ABOAMIST';
                           VP_ACT := 'S';
                   SELECT TIP_PLANTARIF, COD_PLANTARIF,COD_USO
               INTO  V_TIPPLANTARIF, V_PLANTARIF,V_USO
                   FROM GA_ABOAMIST
                   WHERE COD_CLIENTE = VP_CLIENTED
                           AND ROWNUM = 1;
