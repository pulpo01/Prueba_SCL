CREATE OR REPLACE PACKAGE PV_REORDENAMIENTO_PG IS
-- PL/SQL Specification
--
-- *************************************************************
-- * Paquete            : PV_REORDENAMIENTO_PG
-- * Descripcisn        : Procedimientos Almacenados para procesar Comercialmente Reordenamientos de Cuenta Sin Cambios de Plan
-- * Fecha de creacisn  : 13-01-2003 13:02
