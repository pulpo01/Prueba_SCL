CREATE OR REPLACE PROCEDURE        VE_P2_COMIS_HABILITACIONES
(
...
IS
  ...
  vp_procedure VARCHAR2(30):='VE_P2_comis_habilitaciones';
...
IF vp_num_total_ventas >0 THEN
  ...
  ELSE  -- 2202
   ...
   vp_num_total_ventas BETWEEN IMP_DESDE AND IMP_HASTA;
      IF vp_cat_vendedor = 1 AND vp_producto =2 THEN
...
END VE_P2_comis_habilitaciones;
/
SHOW ERRORS
