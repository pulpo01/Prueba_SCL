CREATE OR REPLACE PROCEDURE P_DESHACER_REST_ABO (
...
BEGIN
          ...
          --TMM-04026 Fin
            BEGIN
               vp_tabla := 'GA_ABOCEL';
               vp_act := 'S';
               SELECT num_serie, tip_terminal, cod_cliente, cod_central, num_imei, cod_cuenta,cod_tipcontrato,num_contrato,num_anexo,cod_producto
                 INTO v_serie_nue, v_terminal_nue, v_cliente, v_central, v_imei_nue,v_cuenta,v_tipcontrato,v_contrato,v_anexo,v_producto
                 FROM ga_abocel
