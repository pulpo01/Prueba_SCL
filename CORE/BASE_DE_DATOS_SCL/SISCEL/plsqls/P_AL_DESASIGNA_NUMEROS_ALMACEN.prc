CREATE OR REPLACE PROCEDURE P_AL_DESASIGNA_NUMEROS_ALMACEN(
...
BEGIN
  v_error:=0;
  al_pac_numeracion.p_desasigna_numeracion_almacen (p_subalm,p_central,p_uso,p_cat,p_cantidad,v_error,p_num_sol);
END P_AL_DESASIGNA_NUMEROS_ALMACEN;
/
SHOW ERRORS
