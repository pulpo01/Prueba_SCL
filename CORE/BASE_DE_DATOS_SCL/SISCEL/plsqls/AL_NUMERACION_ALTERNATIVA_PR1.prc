CREATE OR REPLACE PROCEDURE AL_NUMERACION_ALTERNATIVA_PR1 (p_orden al_cab_numeracion.num_numeracion%type) 
IS
	 ...
	 IF v_error = 0 THEN
    	  ...
    	  IF (v_nrosSistema > 0  AND v_nrosSistema >= v_cantnum)  THEN
			  ...
			  IF v_serieBuenas > 0 THEN
				  ...
				  p_asigna_numero_ordenes1(p_orden,1,v_subalm,v_central,v_uso,v_cant,v_cat,v_err);
