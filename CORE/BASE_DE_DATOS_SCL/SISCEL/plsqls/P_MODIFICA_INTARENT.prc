CREATE OR REPLACE PROCEDURE        P_MODIFICA_INTARENT(
  VP_ALQUILER IN NUMBER ,
  VP_ABONADO IN NUMBER ,
  VP_CLIENTE IN NUMBER ,
  VP_IMPLICONS IN NUMBER ,
...
IS
--
-- Procedimiento que refleja los cambios y efectividades de los datos
...
BEGIN
   ...
   LOOP
    ...
    VP_FECSYS,V_FECHASTA,VP_IMPLICONS,
    V_FRIENDS,V_DIASESP,VP_CELDA,
      ...
      VP_ACT := 'U';
      UPDATE GA_INTARENT
         SET IMP_LIMCONSUMO = VP_IMPLICONS,
      COD_CELDA = VP_CELDA,
      NUM_SERIE = VP_SERIE
