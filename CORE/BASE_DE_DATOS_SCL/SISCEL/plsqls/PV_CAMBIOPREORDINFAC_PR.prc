CREATE OR REPLACE procedure PV_CAMBIOPREORDINFAC_PR
...
--
-- *************************************************************
-- * procedimiento      : PV_CAMBIOPREORDINFAC_PR
...
--PV_CAMBIOPREORDINFAC_PR, v1.1 COL-43736|22-10-2007|GEZ
...
BEGIN
   VP_PROC := 'PV_CAMBIOPREORDINFAC_PR';
   ...
   IF VP_PRODUCTO = 1 THEN
      ...
      /* Inicio modificacion by SAQL/Soporte 11/07/2006 - CO-200607050216 */
      AND SYSDATE BETWEEN FEC_ALTA AND FEC_BAJA
      /* Fin modificacion by SAQL/Soporte 11/07/2006 - CO-200607050216 */
      ...
      WHERE ROWID    = V_ROWID;
        ...
        END IF;
                ...
                --VP_TABLA := 'GA_INFACCEL'; --COL-43736|22-10-2007|GEZ
        --VP_ACT         := 'I';                 --COL-43736|22-10-2007|GEZ

                IND_VALOR:=1;

                --INI COL-43736|22-10-2007|GEZ
        ...
        VP_TABLA := 'PV_TRASPASO_INDACTUAC_PG';            --COL-43736|22-10-2007|GEZ
                VP_ACT   := 'P';                                                           --COL-43736|22-10-2007|GEZ
