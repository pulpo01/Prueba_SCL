CREATE OR REPLACE PROCEDURE        VE_P2_COMIS_BONO_MOVILIZACION
(
...
IS
  ...
  vp_procedure VARCHAR2(30):='VE_P2_comis_bono_movilizacion';
...
BEGIN
SELECT COD_CUADRANTE, COD_MONEDA,IMP_BASE,NUM_LIMITE
 INTO vp_cod_cuadrante,vp_cod_moneda,vp_importe_por_venta,vp_limite
...
IF vp_num_total_ventas > vp_limite THEN
 vp_num_total_ventas:=vp_limite;
END IF;
...
END VE_P2_comis_bono_movilizacion;
/
SHOW ERRORS
