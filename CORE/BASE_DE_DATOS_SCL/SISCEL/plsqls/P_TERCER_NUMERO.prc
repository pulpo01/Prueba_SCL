CREATE OR REPLACE PROCEDURE P_TERCER_NUMERO (
...
BEGIN
  ...
  IF VP_USO = '' THEN -- SE INLUYE ESTA VALIDACION PARA LOS CASOS DE ABOANDOS PREPAGO, PARA NO MODIFICAR EL P_INTERFACES_CELULR
  	 		  	 	    --DEBIDO A QUE LOS PREPAGO NO DEBEN ESTAR EN LA GA_INTARCEL
