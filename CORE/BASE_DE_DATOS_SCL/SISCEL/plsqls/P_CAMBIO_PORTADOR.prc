CREATE OR REPLACE PROCEDURE        P_CAMBIO_PORTADOR(
...
--
-- *************************************************************
-- * procedimiento      : P_CAMBIO_PORTADOR
-- * Descripcion        : Procedimiento que refleja el cambio y efectividad del nuevo portador
-- *                      o carrier en las tablas de interfase con tarificacion
-- * Fecha de creacion  :
-- * Responsable        : CRM
  ...
  LOOP
     ...
     INSERT INTO GA_INTARCEL
         ...
         VALUES (V_CLIENTE,V_ABONADO,V_NUMERO,
                 ...
                 V_CELULAR,V_CARGOBASICO,V_CICLO,
                 V_PLANCOM,V_PLANSERV,V_GRPSERV,
                 V_GRUPO,VP_PORTADOR,V_USO,V_NUM_IMSI);
     VP_TABLA := 'GA_INTARCEL';
     VP_ACT := 'U';
      UPDATE GA_INTARCEL
         SET COD_PORTADOR = VP_PORTADOR,NUM_IMSI=V_NUM_IMSI
       WHERE COD_CLIENTE = V_CLIENTE
         AND NUM_ABONADO = V_ABONADO
         AND IND_NUMERO = V_NUMERO
         AND FEC_DESDE > VP_FECSYS;
