CREATE OR REPLACE PROCEDURE        P_GA_SUSPABOCEL
(
...
IS
--
-- Procedimiento de Suspension de Abonados Celulares
--
...
--         - "9" ; Error Insertando ICC_MOVIMIENTO para IND_PLEXSYS='1'
...
-- Modificacion por el prefijo MIN 26/05/99
  ...
  INSERT INTO ICC_MOVIMIENTO
         (NUM_MOVIMIENTO,  NUM_ABONADO,   COD_ESTADO,
          ...
          COD_SUSPREHA,    TIP_TERMINAL,  COD_ACTABO,
          NUM_MOVPOS,      NUM_MIN)
  VALUES (V_MOVABO,       VP_ABONADO ,    '1',
         'GA',            USER,           VP_CODCENTRAL,
          ...
          DECODE(VP_INDPLEX ,1,V_MOVPLEX,NULL), V_PREFIJO);
  IF VP_INDPLEX = '1' THEN
     VP_ERROR := '9' ;
     INSERT INTO ICC_MOVIMIENTO
          (NUM_MOVIMIENTO,  NUM_ABONADO,    COD_ESTADO,
