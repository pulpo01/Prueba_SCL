CREATE OR REPLACE PROCEDURE        Co_DeleteCo_Cartera(iCodTipDocum IN NUMBER, iCodCenEmi IN NUMBER, lNumSecu IN NUMBER,lCodAgente IN NUMBER,
                             sLetra  IN VARCHAR2, vpOutRetorna OUT BOOLEAN)  IS
vp_error        NUMBER(5);
...
BEGIN
    vpOutRetorna:=TRUE;
	sNom_proceso:='Co_DeleteCo_Cartera';
