CREATE OR REPLACE procedure PV_PRC_GETDATOSABONADO_PR
(
...
-- Inicio Modificacion - Rodrigo Mu?oz E. - XM-200404010017 - 13/04/2004
VP_NUM_SERIEHEX                 VARCHAR2(8);
-- Fin Modificacion - Rodrigo Mu?oz E. - XM-200404010017 - 13/04/2004
...
BEGIN
		...
		BEGIN
	        ...
	        --            VP_NUM_IMEI,VP_PLAN
	        SELECT TIP_TERMINAL, COD_TECNOLOGIA, COD_PRODUCTO, NUM_CELULAR, NUM_SERIE, NUM_SERIEHEX, COD_CENTRAL, COD_CLIENTE,
	                   NUM_IMEI,COD_PLANTARIF
	        INTO   VP_TIP_TERMINAL, VP_TIP_TECNOLOGIA, V_COD_PRODUCTO, VP_NUM_CELULAR, VP_NUM_SERIE, VP_NUM_SERIEHEX, VP_COD_CENTRAL, VP_COD_CLIENTE,
	                   VP_NUM_IMEI,VP_PLAN
                -- Fin Modificacion - Rodrigo Mu?oz E. - XM-200404010017 - 13/04/2004
	        FROM   GA_ABOAMIST
	        WHERE  NUM_ABONADO = VP_NUM_ABONADO;
                -- Inicio Modificacion - Rodrigo Mu?oz E. - XM-200404010017 - 13/04/2004
	        IF VP_TIP_TECNOLOGIA = 'CDMA' THEN
	            VP_NUM_SERIE := VP_NUM_SERIEHEX;
	        END IF;
                -- Fin Modificacion - Rodrigo Mu?oz E. - XM-200404010017 - 13/04/2004
		EXCEPTION
