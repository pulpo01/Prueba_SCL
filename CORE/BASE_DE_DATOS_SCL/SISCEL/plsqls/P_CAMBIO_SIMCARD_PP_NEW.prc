CREATE OR REPLACE PROCEDURE P_Cambio_Simcard_PP_New
(VP_ABONADO IN NUMBER
) IS

   V_ABONADO   GA_ABOAMIST.NUM_ABONADO%TYPE;
   V_SERIENEW  GA_ABOAMIST.NUM_SERIE%TYPE;
   V_SERIEOLD  GA_ABOAMIST.NUM_SERIE%TYPE;
   ...
   V_SERVICIOS GA_ABOAMIST.PERFIL_ABONADO%TYPE;
...
from ga_aboamist where num_abonado = V_ABONADO;
...
VALUES ( 
ICC_SEQ_NUMMOV.nextval, VP_ABONADO,1, 'SA', 'GA', 
0, NULL, 'PENDIENTE', 1274, 'SISCEL',  SYSDATE, 
