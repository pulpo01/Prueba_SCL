CREATE OR REPLACE PACKAGE GA_NUMCEL_PERSONAL_TO_U_PG
IS
/*
<Documentación
TipoDoc = "Package">
...
*/
  ...
  CV_PROCEDURE             CONSTANT VARCHAR2(45)  := 'GA_NUMCEL_PERSONAL_TO_U_PG.MODIFICAR_PR';
  CV_0                     CONSTANT VARCHAR2(1)   := '0';
  CV_4                     CONSTANT VARCHAR2(1)   := '4';

  CN_0                     CONSTANT NUMBER(1)  := 0;
  CV_DES_ERROR_V1                  CONSTANT VARCHAR2(70) := 'Error al modificar registro en la tabla GA_NUMCEL_PERSONAL_TO.';
