CREATE OR REPLACE PACKAGE BODY SC_PARAMETROS_SIMPLES_I_PG
IS
  ...
  IS
	  ...
	  EXCEPTION
	      WHEN OTHERS THEN
		      RAISE_APPLICATION_ERROR(-20100, 'Error en SC_PARAMETROS_SIMPLES_I_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
 ...
 END SC_PARAMETROS_SIMPLES_I_PG;
/
SHOW ERRORS
