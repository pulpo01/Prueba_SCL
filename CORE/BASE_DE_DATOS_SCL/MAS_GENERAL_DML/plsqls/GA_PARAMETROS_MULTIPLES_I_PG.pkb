CREATE OR REPLACE PACKAGE BODY GA_PARAMETROS_MULTIPLES_I_PG
IS
 ...
 FUNCTION GA_AGREGAR_HIJO_FN
  ...
  LN_registros_afectados NUMBER;
          ...
          EXCEPTION
              WHEN OTHERS THEN
                      RAISE_APPLICATION_ERROR(-20100, 'Error en GA_PARAMETROS_MULTIPLES_I_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
  END GA_AGREGAR_HIJO_FN;
 END GA_PARAMETROS_MULTIPLES_I_PG;
/
SHOW ERRORS
