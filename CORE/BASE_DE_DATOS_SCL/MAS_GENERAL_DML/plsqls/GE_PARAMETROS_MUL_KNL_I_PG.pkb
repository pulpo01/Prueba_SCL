CREATE OR REPLACE PACKAGE BODY GE_PARAMETROS_MUL_KNL_I_PG
IS
  ...
  IS
	  ...
	  EXCEPTION
          WHEN ERROR_PARAMETROS THEN
	            RAISE_APPLICATION_ERROR(-20101, 'Error en GE_PARAMETROS_MULTIPLES_I_PG 20101: Error en parametros');
	      WHEN OTHERS THEN
		      RAISE_APPLICATION_ERROR(-20100, 'Error en GE_PARAMETROS_MULTIPLES_I_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
 ...
 END GE_PARAMETROS_MUL_KNL_I_PG;
/
SHOW ERRORS
