CREATE OR REPLACE PACKAGE BODY VE_PARAMETROS_SIMPLES_D_PG
IS
  ...
  FUNCTION VE_ELIMINAR_PADRE_FN
      ...
      RETURN NUMBER
        ...
        <Elemento Nombre = "VE_ELIMINAR_PADRE_FN" Lenguaje="PL/SQL" Fecha="" Versi¢n"1.0.0" Dise?ador"DAVID SUTHERLAND" Programador="JAVIER LAMAS" Ambiente="BD">
  ...
  IS
      LN_registros_afectados NUMBER;
          ...
          EXCEPTION
              WHEN OTHERS THEN
                      RAISE_APPLICATION_ERROR(-20100, 'Error en VE_PARAMETROS_SIMPLES_D_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
  END VE_ELIMINAR_PADRE_FN;
