CREATE OR REPLACE PACKAGE BODY GE_PARAMETROS_SIM_KNL_D_PG
IS
  ...
  IS
	  ...
	  EXCEPTION
	      WHEN ERROR_PADRE_CON_HIJOS THEN
	              RAISE_APPLICATION_ERROR(-20102, 'Error en GE_PARAMETROS_SIMPLES_D_PG 20102: El registro a eliminar posee dependencia con otros registros.');
	      WHEN OTHERS THEN
		      RAISE_APPLICATION_ERROR(-20100, 'Error en GE_PARAMETROS_SIMPLES_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
 ...
 END GE_PARAMETROS_SIM_KNL_D_PG;
/
SHOW ERRORS
