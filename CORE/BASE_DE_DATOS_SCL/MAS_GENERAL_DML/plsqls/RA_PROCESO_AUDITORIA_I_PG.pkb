CREATE OR REPLACE PACKAGE BODY RA_PROCESO_AUDITORIA_I_PG
IS
  ...
  FUNCTION GE_AGREGAR_FN
    ...
    /*<Documentacion TipoDoc = "Funci¢n">
        ...
        <Elemento Nombre = "GE_AGREGAR_FN" Lenguaje="PL/SQL" Fecha="" Versi¢n"1.0.0" Diseñador"DAVID SUTHERLAND" Programador="Jose Castillo" Ambiente="BD">
  ...
  BEGIN
     ...
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_I_PG.GE_AGREGAR_FN( TIPO_DOMINIO_MODIFICABLE, 'PROCESO_AUDITORIA', EV_valor, EV_estado, EV_descripcion_valor, EV_usu_creacion );
     ...
     RETURN LN_registros_afectados;
         ...
         EXCEPTION
              ...
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en RA_PROCESO_AUDITORIA_I_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);

  END GE_AGREGAR_FN;

END RA_PROCESO_AUDITORIA_I_PG;
/
SHOW ERRORS
