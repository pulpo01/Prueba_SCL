CREATE OR REPLACE PACKAGE BODY GA_CLIENTES_MAYORISTAS_D_PG
IS
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_D_PG.GE_ELIMINAR_FN( TIPO_DOMINIO_MODIFICABLE, 'CLIENTES_MAYORISTAS', EV_valor );
     ...
     RETURN LN_registros_afectados;
          ...
          EXCEPTION
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en GA_AGRUPCOMER_D_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
