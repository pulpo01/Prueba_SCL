CREATE OR REPLACE PACKAGE BODY SE_TIPO_UNIDAD_BONIFICA_D_PG
IS
  ...
  FUNCTION SE_ELIMINAR_FN
	...
	<Elemento Nombre = "SE_ELIMINAR_FN Lenguaje="PL/SQL" Fecha="" Version"1.0.0" Diseñador"DAVID SUTHERLAND" Programador="JAVIER LAMAS" Ambiente="BD">
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_D_PG.GE_ELIMINAR_FN( TIPO_DOMINIO_MODIFICABLE, 'TIPO_UNIDAD_BONIFICA', EV_valor );
     ...
     RETURN LN_registros_afectados;
	  ...
	  EXCEPTION
	      WHEN OTHERS THEN
	       ...
	       RAISE_APPLICATION_ERROR(-20100, 'Error en SE_TIPO_UNIDAD_BONIFICA_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
  END SE_ELIMINAR_FN;
