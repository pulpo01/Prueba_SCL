CREATE OR REPLACE PACKAGE BODY AL_PARAMETROS_SIMPLES_U_PG
IS
  ...
  IS
      LN_registros_afectados NUMBER;
         ...
         RETURN LN_registros_afectados;
          ...
          EXCEPTION
              WHEN OTHERS THEN
                      RAISE_APPLICATION_ERROR(-20100, 'Error en AL_PARAMETROS_SIMPLES_U_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
  END AL_ACTUALIZAR_HIJO_FN;


 END AL_PARAMETROS_SIMPLES_U_PG;
/
SHOW ERRORS
