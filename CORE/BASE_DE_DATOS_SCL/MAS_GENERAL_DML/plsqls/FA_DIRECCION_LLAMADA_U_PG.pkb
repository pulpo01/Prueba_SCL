CREATE OR REPLACE PACKAGE BODY FA_DIRECCION_LLAMADA_U_PG
IS
...
/*<Documentacion TipoDoc = "Funci¢n">
	<Elemento Nombre = "GE_AGREGAR_FN" Lenguaje="PL/SQL" Fecha="" Versi¢n"1.0.0" Dise?ador"DAVID SUTHERLAND" Programador="CRISTIAN RETAMAL" Ambiente="BD">
	<Retorno>NUMBER</Retorno>
	<Descripcion>Modifica un valor para un dominio. Se realiza la inserci¢n en la tabla GE_VALORES_DOMINIOS_TD</Descripci¢n>
	<Parametros>
	<Entrada>
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_U_PG.GE_MODIFICAR_FN( TIPO_DOMINIO_MODIFICABLE, 'DIRECCION_LLAMADA', EV_valor, EV_estado, EV_descripcion_valor, EV_usu_modificacion );
     ...
     RETURN LN_registros_afectados;
	  ...
	  EXCEPTION
	      WHEN OTHERS THEN
	       ...
	       RAISE_APPLICATION_ERROR(-20100, 'Error en FA_DIRECCION_LLAMADA_U_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
  END FA_MODIFICAR_FN;


 END FA_DIRECCION_LLAMADA_U_PG;
/
SHOW ERRORS
