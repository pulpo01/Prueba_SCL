CREATE OR REPLACE PACKAGE BODY SE_TIPO_SERVICIO_D_PG
IS
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_D_PG.GE_ELIMINAR_FN( TIPO_DOMINIO_MODIFICABLE, 'TIPO_SERVICIO', EV_valor );
     ...
     RETURN LN_registros_afectados;
	  ...
	  EXCEPTION
	      WHEN OTHERS THEN
	       ...
	       RAISE_APPLICATION_ERROR(-20100, 'Error en SE_TIPO_SERVICIO_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
  END SE_ELIMINAR_FN;
