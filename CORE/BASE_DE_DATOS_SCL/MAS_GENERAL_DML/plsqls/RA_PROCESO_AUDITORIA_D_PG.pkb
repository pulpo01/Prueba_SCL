CREATE OR REPLACE PACKAGE BODY RA_PROCESO_AUDITORIA_D_PG
IS
  ...
  BEGIN
     ...
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_D_PG.GE_ELIMINAR_FN( TIPO_DOMINIO_MODIFICABLE, 'PROCESO_AUDITORIA', EV_valor );
     ...
     RETURN LN_registros_afectados;
         ...
         EXCEPTION
              ...
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en RA_PROCESO_AUDITORIA_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);

  END GE_ELIMINAR_FN;


END RA_PROCESO_AUDITORIA_D_PG;
/
SHOW ERRORS
