CREATE OR REPLACE PACKAGE BODY GA_CLIENTES_MAYORISTAS_U_PG
IS
...
/*<Documentacion TipoDoc = "Funci¢n">
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_U_PG.GE_MODIFICAR_FN( TIPO_DOMINIO_MODIFICABLE, 'CLIENTES_MAYORISTAS', EV_valor, EV_estado, EV_descripcion_valor, EV_usu_modificacion );
     ...
     RETURN LN_registros_afectados;
          ...
          EXCEPTION
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en GA_AGRUPCOMER_U_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
  END GA_MODIFICAR_FN;


 END GA_CLIENTES_MAYORISTAS_U_PG;
/
SHOW ERRORS
