CREATE OR REPLACE PACKAGE BODY RA_TIPO_AUDITORIA_I_PG
IS
  ...
  BEGIN
     ...
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_I_PG.GE_AGREGAR_FN( TIPO_DOMINIO_MODIFICABLE, 'TIPO_AUDITORIA', EV_valor, EV_estado, EV_descripcion_valor, EV_usu_creacion );
	 ...
	 EXCEPTION
	      ...
	      WHEN OTHERS THEN
	       ...
	       RAISE_APPLICATION_ERROR(-20100, 'Error en RA_TIPO_AUDITORIA_I_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
