CREATE OR REPLACE PACKAGE BODY FA_FACTOR_TIPO_UNIDAD_D_PG
IS
  ...
  FUNCTION FA_ELIMINAR_FN
      ...
      RETURN NUMBER
        ...
        <Elemento Nombre = "FA_ELIMINAR_FN Lenguaje="PL/SQL" Fecha="" Version"1.0.0" Diseñador"DAVID SUTHERLAND" Programador="JAVIER LAMAS" Ambiente="BD">
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_D_PG.GE_ELIMINAR_FN( TIPO_DOMINIO_MODIFICABLE, 'FACTOR_TIPO_UNIDAD', EV_valor );
     ...
     RETURN LN_registros_afectados;
          ...
          EXCEPTION
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en FA_FACTOR_TIPO_UNIDAD_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
  END FA_ELIMINAR_FN;
