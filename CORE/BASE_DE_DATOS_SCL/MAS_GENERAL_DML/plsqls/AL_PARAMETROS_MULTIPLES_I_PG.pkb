CREATE OR REPLACE PACKAGE BODY AL_PARAMETROS_MULTIPLES_I_PG
IS
  ...
  IS
      LN_registros_afectados NUMBER;
          ...
          EXCEPTION
              WHEN OTHERS THEN
                      RAISE_APPLICATION_ERROR(-20100, 'Error en AL_PARAMETROS_MULTIPLES_I_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);
 ...
 END AL_PARAMETROS_MULTIPLES_I_PG;
/
SHOW ERRORS
