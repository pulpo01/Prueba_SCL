CREATE OR REPLACE PACKAGE BODY SC_PARAMETROS_MULTIPLES_D_PG
IS
  ...
  IS
	  ...
	  EXCEPTION
	      WHEN OTHERS THEN
		      RAISE_APPLICATION_ERROR(-20100, 'Error en SC_PARAMETROS_MULTIPLES_D_PG ' || to_char(SQLCODE) || ': ' || SQLERRM);
 ...
 END SC_PARAMETROS_MULTIPLES_D_PG;
/
SHOW ERRORS
