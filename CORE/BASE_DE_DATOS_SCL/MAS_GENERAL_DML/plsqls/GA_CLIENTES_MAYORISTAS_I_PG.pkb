CREATE OR REPLACE PACKAGE BODY GA_CLIENTES_MAYORISTAS_I_PG
IS
...
/*<Documentacion TipoDoc = "Funci¢n">
  ...
  BEGIN
     LN_registros_afectados := GE_VALORES_DOMINIOS_KNL_I_PG.GE_AGREGAR_FN( TIPO_DOMINIO_MODIFICABLE, 'CLIENTES_MAYORISTAS', EV_valor, EV_estado, EV_descripcion_valor, EV_usu_creacion );
     ...
     RETURN LN_registros_afectados;
          ...
          EXCEPTION
              WHEN OTHERS THEN
               ...
               RAISE_APPLICATION_ERROR(-20100, 'Error en GA_AGRUPCOMER_I_PG ' || TO_CHAR(SQLCODE) || ': ' || SQLERRM);

  END GA_AGREGAR_FN;

END GA_CLIENTES_MAYORISTAS_I_PG;
/
SHOW ERRORS
