CREATE OR REPLACE TRIGGER AUD_GEIMP_AFDE_TG
AFTER DELETE ON GE_IMPUESTOS
...
N_RESPUESTA := AUD_AUDITORIA_PG.AUD_REGISTRA_AUDITORIA_FN ('SISCEL','GE_IMPUESTOS','DELETE',V_ID_REGISTRO,V_DETALLE);
EXCEPTION
        WHEN ERROR_PROCESO THEN
           null;
END AUD_GEIMP_AFDE_TR;
/
SHOW ERRORS
