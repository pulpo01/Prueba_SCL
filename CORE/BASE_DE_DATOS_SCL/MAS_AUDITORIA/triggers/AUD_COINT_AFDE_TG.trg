CREATE OR REPLACE TRIGGER AUD_COINT_AFDE_TG
AFTER DELETE ON CO_INTERESES
...
N_RESPUESTA := AUD_AUDITORIA_PG.AUD_REGISTRA_AUDITORIA_FN ('SISCEL','CO_INTERESES','DELETE',V_ID_REGISTRO,V_DETALLE);
EXCEPTION
        WHEN ERROR_PROCESO THEN
           null;
END AUD_COINT_AFDE_TR;
/
SHOW ERRORS
